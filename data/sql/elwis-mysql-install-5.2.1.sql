...
@author: Miguel Rojas
Installation script based in the elwis database version 5.2.1
This script runs for BM 5.3.4
...
CREATE TABLE `actionposition` (
  ...
  `unitpricegross` decimal(14,4) DEFAULT NULL,
  `version` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `addaddress` (
  `addaddressid` int(11) NOT NULL,
  `addressid` int(11) NOT NULL,
  `addaddressline` varchar(200) DEFAULT NULL,
  `addaddresstype` smallint(6) NOT NULL DEFAULT '2',
  ...
  PRIMARY KEY (`addaddressid`),
  KEY `addressid` (`addressid`),
  KEY `cityid` (`cityid`),
  KEY `commentid` (`commentid`),
  KEY `companyid` (`companyid`),
  KEY `countryid` (`countryid`),
  CONSTRAINT `addaddress_ibfk_1` FOREIGN KEY (`addressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `addaddress_ibfk_2` FOREIGN KEY (`cityid`) REFERENCES `city` (`cityid`),
  CONSTRAINT `addaddress_ibfk_3` FOREIGN KEY (`commentid`) REFERENCES `freetext` (`freetextid`),
  CONSTRAINT `addaddress_ibfk_4` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `addaddress_ibfk_5` FOREIGN KEY (`countryid`) REFERENCES `country` (`countryid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `addressrelation` */

CREATE TABLE `addressrelation` (
  `addressid` int(11) NOT NULL,
  `relatedaddressid` int(11) NOT NULL,
  `commentid` int(11) DEFAULT NULL,
  `companyid` int(11) NOT NULL,
  ...
  KEY `addressid` (`addressid`),
  KEY `relatedaddressid` (`relatedaddressid`),
  KEY `commentid` (`commentid`),
  KEY `companyid` (`companyid`),
  KEY `relationtypeid` (`relationtypeid`),
  CONSTRAINT `addressrelation_ibfk_1` FOREIGN KEY (`addressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `addressrelation_ibfk_2` FOREIGN KEY (`relatedaddressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `addressrelation_ibfk_3` FOREIGN KEY (`commentid`) REFERENCES `freetext` (`freetextid`),
  CONSTRAINT `addressrelation_ibfk_4` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `addressrelation_ibfk_5` FOREIGN KEY (`relationtypeid`) REFERENCES `addressreltype` (`relationtypeid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `addressreltype` */

CREATE TABLE `addressreltype` (
  `companyid` int(11) NOT NULL,
  `relationtypeid` int(11) NOT NULL,
  `relationtype` smallint(6) NOT NULL,
  `title` varchar(150) NOT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`relationtypeid`),
  KEY `companyid` (`companyid`),
  CONSTRAINT `addressreltype_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `appointment` (
  ...
  KEY `ap_userdate` (`userid`,`startdatetime`,`enddatetime`),
...
CREATE TABLE `attach` (
  ...
  `companyid` int(11) NOT NULL DEFAULT '0',
  `emlattachuuid` varchar(50) DEFAULT NULL,
  `file` longblob,
...
CREATE TABLE `bankaccount` (
  ...
  CONSTRAINT `bankaccount_ibfk_1` FOREIGN KEY (`accountid`) REFERENCES `account` (`accountid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `campaign` (
  ...
  `emailtelecomtype` int(11) DEFAULT NULL,
  `employeeid` int(11) DEFAULT NULL,
  `hasemail` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `campcriterionvalue` (
  ...
  `relationfield` varchar(30) DEFAULT NULL,
  `cpersonfield` varchar(30) DEFAULT NULL,
...
CREATE TABLE `campgeneration` (
  ...
  `companyid` int(11) NOT NULL DEFAULT '0',
  `createcomm` tinyint(4) DEFAULT NULL,
  `documenttype` tinyint(4) DEFAULT NULL,
  `employeemail` varchar(100) DEFAULT NULL,
  `generationid` int(11) NOT NULL DEFAULT '0',
  `generationtime` bigint(20) NOT NULL DEFAULT '0',
  `senderemployeeid` int(11) DEFAULT NULL,
  `senderprefix` varchar(120) DEFAULT NULL,
  `senderprefixtype` tinyint(4) DEFAULT NULL,
  ...
  CONSTRAINT `campgeneration_ibfk_5` FOREIGN KEY (`campaignid`) REFERENCES `campaign` (`campaignid`),
  CONSTRAINT `campgeneration_ibfk_6` FOREIGN KEY (`telecomtypeid`) REFERENCES `telecomtype` (`telecomtypeid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
/*Table structure for table `campsentlog` */

CREATE TABLE `campsentlog` (
  `campsentlogid` int(11) NOT NULL,
  `companyid` int(11) NOT NULL,
  `generationid` int(11) NOT NULL,
  `generationkey` bigint(20) DEFAULT NULL,
  `totalsent` int(11) NOT NULL,
  `totalsuccess` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`campsentlogid`),
  KEY `companyid` (`companyid`),
  KEY `generationid` (`generationid`),
  CONSTRAINT `campsentlog_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `campsentlog_ibfk_2` FOREIGN KEY (`generationid`) REFERENCES `campgeneration` (`generationid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `categfieldvalue` (
  ...
  CONSTRAINT `categfieldvalue_ibfk_12` FOREIGN KEY (`salepositionid`) REFERENCES `saleposition` (`salepositionid`),
...
CREATE TABLE `company` (
  ...
  `invmailtemplatid` int(11) DEFAULT NULL,
  ...
  KEY `salutationid` (`salutationid`),
  KEY `invmailtemplatid` (`invmailtemplatid`),
  ...
  CONSTRAINT `company_ibfk_5` FOREIGN KEY (`invmailtemplatid`) REFERENCES `template` (`templateid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `contact` (
  `addressid` int(11) NOT NULL DEFAULT '0',
  `addaddressid` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `contact_ibfk_2` FOREIGN KEY (`addaddressid`) REFERENCES `addaddress` (`addaddressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `contactperson` (
  ...
  CONSTRAINT `contactperson_ibfk_2` FOREIGN KEY (`addaddressid`) REFERENCES `addaddress` (`addaddressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `customer` (
  ...
  `defaultdiscount` decimal(13,2) DEFAULT NULL,
  `employeeid` int(11) DEFAULT NULL,
  `invoiceaddressid` int(11) DEFAULT NULL,
  `invoicecontactpersonid` int(11) DEFAULT NULL,
  ...
  KEY `employeeid` (`employeeid`),
  KEY `invoiceaddressid` (`invoiceaddressid`,`invoicecontactpersonid`),
  KEY `addaddressid` (`addaddressid`),
  ...
  CONSTRAINT `customer_ibfk_2` FOREIGN KEY (`invoiceaddressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `customer_ibfk_3` FOREIGN KEY (`invoiceaddressid`, `invoicecontactpersonid`) REFERENCES `contactperson` (`addressid`, `contactpersonid`),
  CONSTRAINT `customer_ibfk_4` FOREIGN KEY (`addaddressid`) REFERENCES `addaddress` (`addaddressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `customertype` (
  ...
  `customertypename` varchar(40) DEFAULT NULL,
  `version` int(11) DEFAULT NULL,
...
/*Table structure for table `deduplicontact` */

CREATE TABLE `deduplicontact` (
  `companyid` int(11) NOT NULL,
  `deduplicontactid` int(11) NOT NULL,
  `starttime` bigint(20) NOT NULL,
  `status` smallint(6) NOT NULL,
  `userid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`deduplicontactid`),
  KEY `companyid` (`companyid`),
  KEY `userid` (`userid`),
  CONSTRAINT `deduplicontact_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `deduplicontact_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `elwisuser` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `duplicateaddress` */

CREATE TABLE `duplicateaddress` (
  `addressid` int(11) NOT NULL,
  `companyid` int(11) NOT NULL,
  `duplicategroupid` int(11) NOT NULL,
  `ismain` smallint(6) NOT NULL,
  `positionindex` int(11) NOT NULL,
  PRIMARY KEY (`duplicategroupid`,`addressid`),
  KEY `companyid` (`companyid`),
  KEY `addressid` (`addressid`),
  CONSTRAINT `duplicateaddress_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `duplicateaddress_ibfk_2` FOREIGN KEY (`duplicategroupid`) REFERENCES `duplicategroup` (`duplicategroupid`),
  CONSTRAINT `duplicateaddress_ibfk_3` FOREIGN KEY (`addressid`) REFERENCES `address` (`addressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `duplicategroup` */
...
CREATE TABLE `duplicategroup` (
  ...
  `duplicategroupid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`duplicategroupid`),
  KEY `companyid` (`companyid`),
  KEY `deduplicontactid` (`deduplicontactid`),
  CONSTRAINT `duplicategroup_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `duplicategroup_ibfk_2` FOREIGN KEY (`deduplicontactid`) REFERENCES `deduplicontact` (`deduplicontactid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `dynamicsearch` */

CREATE TABLE `dynamicsearch` (
  `companyid` int(11) NOT NULL,
  `dynamicsearchid` int(11) NOT NULL,
  `module` varchar(50) NOT NULL,
  `name` varchar(50) NOT NULL,
  `userid` int(11) NOT NULL,
  PRIMARY KEY (`dynamicsearchid`),
  KEY `companyid` (`companyid`),
  KEY `userid` (`userid`),
  CONSTRAINT `dynamicsearch_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `dynamicsearch_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `elwisuser` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `dysearchfield` */

CREATE TABLE `dysearchfield` (
  `alias` varchar(50) NOT NULL,
  `companyid` int(11) NOT NULL,
  `dynamicsearchid` int(11) NOT NULL,
  `dysearchfieldid` int(11) NOT NULL,
  `position` int(11) NOT NULL,
  PRIMARY KEY (`dysearchfieldid`),
  KEY `companyid` (`companyid`),
  KEY `dynamicsearchid` (`dynamicsearchid`),
  CONSTRAINT `dysearchfield_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `dysearchfield_ibfk_2` FOREIGN KEY (`dynamicsearchid`) REFERENCES `dynamicsearch` (`dynamicsearchid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `elwisuser` (
  ...
  `companyid` int(11) NOT NULL DEFAULT '0',
  `csvdelimiter` varchar(5) DEFAULT NULL,
  ...
  `reportcharset` varchar(30) DEFAULT NULL,
  `rowsperpage` int(11) DEFAULT NULL,
...
CREATE TABLE `importprofile` (
  `checkduplicate` smallint(6) NOT NULL DEFAULT '1',
  `companyid` int(11) NOT NULL,
  `importstarttime` bigint(20) DEFAULT NULL,
...
CREATE TABLE `importrecord` (
  ...
  `importrecordid` int(11) NOT NULL,
  `isduplicate` smallint(6) NOT NULL,
  ...
  `recordtype` smallint(6) NOT NULL,
  `street` varchar(100) DEFAULT NULL,
  `version` int(11) NOT NULL,
  `zip` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`importrecordid`),
  KEY `companyid` (`companyid`),
  KEY `profileid` (`profileid`),
  KEY `parentrecordid` (`parentrecordid`),
  KEY `organizationid` (`organizationid`),
  CONSTRAINT `importrecord_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `importrecord_ibfk_2` FOREIGN KEY (`profileid`) REFERENCES `importprofile` (`profileid`),
  CONSTRAINT `importrecord_ibfk_3` FOREIGN KEY (`parentrecordid`) REFERENCES `importrecord` (`importrecordid`),
  CONSTRAINT `importrecord_ibfk_4` FOREIGN KEY (`organizationid`) REFERENCES `address` (`addressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `invoice` (
  ...
  `sentaddressid` int(11) DEFAULT NULL,
  `sentcontactpersonid` int(11) DEFAULT NULL,
  `sequenceruleid` int(11) DEFAULT NULL,
  `type` smallint(6) NOT NULL DEFAULT '0',
  ...
  KEY `sequenceruleid` (`sequenceruleid`),
  KEY `sentaddressid` (`sentaddressid`,`sentcontactpersonid`),
  KEY `addaddressid` (`addaddressid`),
  ...
  CONSTRAINT `invoice_ibfk_11` FOREIGN KEY (`sequenceruleid`) REFERENCES `sequencerule` (`numberid`),
  CONSTRAINT `invoice_ibfk_12` FOREIGN KEY (`sentaddressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `invoice_ibfk_13` FOREIGN KEY (`sentaddressid`, `sentcontactpersonid`) REFERENCES `contactperson` (`addressid`, `contactpersonid`),
  CONSTRAINT `invoice_ibfk_14` FOREIGN KEY (`addaddressid`) REFERENCES `addaddress` (`addaddressid`),
...
CREATE TABLE `invoicefreenum` (
  ...
  CONSTRAINT `invoicefreenum_ibfk_2` FOREIGN KEY (`sequenceruleid`) REFERENCES `sequencerule` (`numberid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `invoicepayment` (
  ...
  CONSTRAINT `invoicepayment_ibfk_5` FOREIGN KEY (`bankaccountid`) REFERENCES `bankaccount` (`bankaccountid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `invoiceposition` (
  ...
  `unitprice` decimal(14,4) DEFAULT NULL,
  `unitpricegross` decimal(14,4) DEFAULT NULL,
  `version` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `mail` (
  ...
  `isdrafttemp` tinyint(4) DEFAULT NULL,
  ...
  KEY `part_of_header` (`messageidheader`(10)),
...
/*Table structure for table `mailaccerrdetail` */

CREATE TABLE `mailaccerrdetail` (
  `accerrdetailid` int(11) NOT NULL,
  `companyid` int(11) NOT NULL,
  `emails` varchar(250) DEFAULT NULL,
  `mailaccerrorid` int(11) NOT NULL,
  `mailidentifier` int(11) DEFAULT NULL,
  `subject` varchar(250) DEFAULT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`accerrdetailid`),
  KEY `companyid` (`companyid`),
  KEY `mailaccerrorid` (`mailaccerrorid`),
  CONSTRAINT `mailaccerrdetail_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `mailaccerrdetail_ibfk_2` FOREIGN KEY (`mailaccerrorid`) REFERENCES `mailaccerror` (`mailaccerrorid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `mailaccerror` */

CREATE TABLE `mailaccerror` (
  `causedby` varchar(250) DEFAULT NULL,
  `companyid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `mailaccount` (
  ...
  `companyid` int(11) NOT NULL DEFAULT '0',
  `createincontact` tinyint(4) NOT NULL DEFAULT '0',
  `createoutcontact` tinyint(4) NOT NULL DEFAULT '0',
  ...
  `removeafterof` int(11) DEFAULT NULL,
  ...
  `smtpssl` smallint(6) DEFAULT NULL,
  `usermailid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `mailcontact` (
  ...
  KEY `mailid` (`mailid`),
  KEY `contactid` (`contactid`),
  KEY `companyid_2` (`companyid`,`mailid`,`contactid`),
  KEY `companyid_3` (`companyid`,`mailid`),
...
CREATE TABLE `mailrecipient` (
  ...
  KEY `companyid` (`companyid`),
  KEY `mailid` (`mailid`),
  KEY `companyid_2` (`companyid`,`mailid`),
...
CREATE TABLE `mailuidltrack` (
  `companyid` int(11) NOT NULL DEFAULT '0',
  `deletefrompopat` bigint(20) DEFAULT NULL,
  `mailaccountid` int(11) NOT NULL DEFAULT '0',
  `uidl` varchar(250) DEFAULT NULL,
  ...
  KEY `companyid` (`companyid`),
  KEY `mailaccountid` (`mailaccountid`),
  KEY `companyid_2` (`companyid`,`mailaccountid`),
  KEY `companyid_3` (`companyid`,`mailaccountid`),
...
CREATE TABLE `passwordchange` (
  ...
  `passwordchangeid` int(11) NOT NULL,
  ...
  KEY `companyid` (`companyid`),
  KEY `userid` (`userid`),
  CONSTRAINT `passwordchange_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `passwordchange_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `elwisuser` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `productcontract` (
  ...
  `priceperiod` tinyint(4) DEFAULT NULL,
  ...
  CONSTRAINT `productcontract_ibfk_12` FOREIGN KEY (`sentaddressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `productcontract_ibfk_13` FOREIGN KEY (`sentaddressid`, `sentcontactpersonid`) REFERENCES `contactperson` (`addressid`, `contactpersonid`),
  CONSTRAINT `productcontract_ibfk_14` FOREIGN KEY (`addaddressid`) REFERENCES `addaddress` (`addaddressid`),
...
/*Table structure for table `recordcolumn` */
...
CREATE TABLE `recordcolumn` (
  ...
  `importcolumnid` int(11) NOT NULL,
  `importrecordid` int(11) NOT NULL,
  PRIMARY KEY (`importrecordid`,`importcolumnid`),
  KEY `companyid` (`companyid`),
  KEY `importcolumnid` (`importcolumnid`),
  CONSTRAINT `recordcolumn_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `recordcolumn_ibfk_2` FOREIGN KEY (`importrecordid`) REFERENCES `importrecord` (`importrecordid`),
  CONSTRAINT `recordcolumn_ibfk_3` FOREIGN KEY (`importcolumnid`) REFERENCES `importcolumn` (`importcolumnid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `recordduplicate` */

CREATE TABLE `recordduplicate` (
  `addressid` int(11) NOT NULL,
  `companyid` int(11) NOT NULL,
  `importrecordid` int(11) NOT NULL,
  PRIMARY KEY (`importrecordid`,`addressid`),
  KEY `companyid` (`companyid`),
  KEY `addressid` (`addressid`),
  CONSTRAINT `recordduplicate_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `recordduplicate_ibfk_2` FOREIGN KEY (`importrecordid`) REFERENCES `importrecord` (`importrecordid`),
  CONSTRAINT `recordduplicate_ibfk_3` FOREIGN KEY (`addressid`) REFERENCES `address` (`addressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `report` (
  ...
  `jrxmlfileid` int(11) DEFAULT NULL,
  `jrxmlfilename` varchar(200) DEFAULT NULL,
  ...
  `sourcetype` tinyint(4) NOT NULL DEFAULT '1',
  ...
  CONSTRAINT `report_ibfk_4` FOREIGN KEY (`jrxmlfileid`) REFERENCES `freetext` (`freetextid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

/*Table structure for table `reportartifact` */
...
/*Table structure for table `reportqueryparam` */

CREATE TABLE `reportqueryparam` (
  `companyid` int(11) NOT NULL,
  `parametername` varchar(100) NOT NULL,
  `queryparamid` int(11) NOT NULL,
  `reportfilterid` int(11) DEFAULT NULL,
  `reportid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`queryparamid`),
  KEY `companyid` (`companyid`),
  KEY `reportfilterid` (`reportfilterid`),
  KEY `reportid` (`reportid`),
  CONSTRAINT `reportqueryparam_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `reportqueryparam_ibfk_2` FOREIGN KEY (`reportfilterid`) REFERENCES `reportfilter` (`reportfilterid`),
  CONSTRAINT `reportqueryparam_ibfk_3` FOREIGN KEY (`reportid`) REFERENCES `report` (`reportid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `rolepasschange` */

CREATE TABLE `rolepasschange` (
  `companyid` int(11) NOT NULL,
  `passwordchangeid` int(11) NOT NULL,
  `roleid` int(11) NOT NULL,
  PRIMARY KEY (`passwordchangeid`,`roleid`),
  KEY `companyid` (`companyid`),
  KEY `roleid` (`roleid`),
  CONSTRAINT `rolepasschange_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `rolepasschange_ibfk_2` FOREIGN KEY (`passwordchangeid`) REFERENCES `passwordchange` (`passwordchangeid`),
  CONSTRAINT `rolepasschange_ibfk_3` FOREIGN KEY (`roleid`) REFERENCES `role` (`roleid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sale` (
  ...
  CONSTRAINT `sale_ibfk_10` FOREIGN KEY (`sentaddressid`, `sentcontactpersonid`) REFERENCES `contactperson` (`addressid`, `contactpersonid`),
  CONSTRAINT `sale_ibfk_11` FOREIGN KEY (`addaddressid`) REFERENCES `addaddress` (`addaddressid`),
  ...
  CONSTRAINT `sale_ibfk_9` FOREIGN KEY (`sentaddressid`) REFERENCES `address` (`addressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `sentlogcontact` */
...
CREATE TABLE `sentlogcontact` (
  ...
  `generationkey` bigint(20) DEFAULT NULL,
  `sentlogcontactid` int(11) NOT NULL,
  `status` tinyint(4) NOT NULL,
  `userid` int(11) DEFAULT NULL,
  `version` int(11) NOT NULL,
  PRIMARY KEY (`sentlogcontactid`),
  KEY `companyid` (`companyid`),
  KEY `campsentlogid` (`campsentlogid`),
  KEY `addressid` (`addressid`,`contactpersonid`),
  KEY `userid` (`userid`),
  CONSTRAINT `sentlogcontact_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `sentlogcontact_ibfk_2` FOREIGN KEY (`addressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `sentlogcontact_ibfk_3` FOREIGN KEY (`campsentlogid`) REFERENCES `campsentlog` (`campsentlogid`),
  CONSTRAINT `sentlogcontact_ibfk_4` FOREIGN KEY (`addressid`, `contactpersonid`) REFERENCES `contactperson` (`addressid`, `contactpersonid`),
  CONSTRAINT `sentlogcontact_ibfk_5` FOREIGN KEY (`userid`) REFERENCES `elwisuser` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sequencerule` (
  `companyid` int(11) NOT NULL DEFAULT '0',
  `debitorid` int(11) DEFAULT NULL,
  `debitornumber` varchar(20) DEFAULT NULL,
  ...
  KEY `companyid` (`companyid`),
  KEY `debitorid` (`debitorid`),
  CONSTRAINT `sequencerule_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `sequencerule_ibfk_2` FOREIGN KEY (`debitorid`) REFERENCES `address` (`addressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `supportcontact` (
  ...
  KEY `caseid` (`caseid`),
  KEY `activityid` (`activityid`),
  KEY `caseid_2` (`caseid`,`contactid`,`activityid`),
...
/*Table structure for table `tableusage` */

CREATE TABLE `tableusage` (
  `dateofmeasure` int(11) DEFAULT NULL,
  `companyno` int(11) DEFAULT NULL,
  `tablename` varchar(100) DEFAULT NULL,
  `records` int(11) DEFAULT NULL,
  `space` int(11) DEFAULT NULL,
  KEY `tu_idx1` (`companyno`,`tablename`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Table structure for table `tableusagetables` */

CREATE TABLE `tableusagetables` (
  `tablename` varchar(100) DEFAULT '0',
  `module` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Table structure for table `tableusagetemp` */

CREATE TABLE `tableusagetemp` (
  `dateofmeasure` int(11) DEFAULT NULL,
  `companyno` int(11) DEFAULT NULL,
  `tablename` varchar(100) DEFAULT NULL,
  `records` int(11) DEFAULT NULL,
...
/*Table structure for table `temporaltable` */
...
/*Table structure for table `useraddressaccess` */

CREATE TABLE `useraddressaccess` (
  `addressid` int(11) NOT NULL,
  `companyid` int(11) NOT NULL,
  `usergroupid` int(11) NOT NULL,
  PRIMARY KEY (`addressid`,`usergroupid`),
  KEY `companyid` (`companyid`),
  KEY `usergroupid` (`usergroupid`),
  CONSTRAINT `useraddressaccess_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `useraddressaccess_ibfk_2` FOREIGN KEY (`addressid`) REFERENCES `address` (`addressid`),
  CONSTRAINT `useraddressaccess_ibfk_3` FOREIGN KEY (`usergroupid`) REFERENCES `usergroup` (`usergroupid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `userpasschange` */

CREATE TABLE `userpasschange` (
  `companyid` int(11) NOT NULL,
  `passwordchangeid` int(11) NOT NULL,
  `userid` int(11) NOT NULL,
  PRIMARY KEY (`passwordchangeid`,`userid`),
  KEY `companyid` (`companyid`),
  KEY `userid` (`userid`),
  CONSTRAINT `userpasschange_ibfk_1` FOREIGN KEY (`companyid`) REFERENCES `company` (`companyid`),
  CONSTRAINT `userpasschange_ibfk_2` FOREIGN KEY (`passwordchangeid`) REFERENCES `passwordchange` (`passwordchangeid`),
  CONSTRAINT `userpasschange_ibfk_3` FOREIGN KEY (`userid`) REFERENCES `elwisuser` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
lastmoddate, lastmoduser, name1, name2, name3, personal, recorddate,
recorduser, salutationid, searchname, street, taxnumber, titleid, version,
waydescriptionid) values
(1, 1, '0', NULL, NULL, NULL, 9, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
20071107, 1, 'Jatun S.R.L.', 'Innovación & Desarrollo', NULL, 0, 20071107,
1, NULL, 'Jatun', NULL, NULL, NULL, 1, NULL);
...
20071107, 1, 'Montaño', 'Fernando', NULL, 0, 20071107,
1, NULL, 'fer', NULL, NULL, NULL, 1, NULL);
...
INSERT INTO campcriterionvalue(campcriterionvalueid, tableid, descriptionkey, field, fieldtype, fieldname, tablename, relationfield) VALUES(27, 3 , 'CampaignCriteria.salePosition.contactPerson', 'positionContactPersonId', 7, '0', 'saleposition', 'contactPersonId');
INSERT INTO campcriterionvalue(campcriterionvalueid, tableid, descriptionkey, field, fieldtype, fieldname, tablename, relationfield) VALUES(28, 4 , "Contact.Person.salutation", "salutationid", 6, "salutationlabel", "salutation", null);
