...
public class SupportCaseIntegrationServiceDelegate {
    ...
    private static final String JNDI_SUPPORTCASEINTEGRATIONSERVICE = "ELWIS/SupportCaseIntegrationService/local";
    ...
    public SupportCaseIntegrationService getSupportCaseIntegrationService() {
        ...
        try {
            service = (SupportCaseIntegrationService) ServiceLocator.i.lookup(JNDI_SUPPORTCASEINTEGRATIONSERVICE);
