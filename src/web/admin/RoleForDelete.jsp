...
<c:set var="helpResourceKey" value="help.role.delete" scope="request"/>

<fmt:message   var="title" key="Admin.Role.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Role/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Admin.title" scope="request"/>
<c:set var="windowTitle" value="Admin.Role.delete" scope="request"/>
