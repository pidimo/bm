...
<c:set var="helpResourceKey" value="help.reportJrxml.artifact.delete" scope="request"/>

<fmt:message  var="title" key="Report.artifact.delete" scope="request"/>
<fmt:message  var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/Report/Artifact/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="Report.artifact.delete" scope="request"/>
