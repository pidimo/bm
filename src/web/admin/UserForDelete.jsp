...
<c:set var="helpResourceKey" value="help.user.delete" scope="request"/>

<fmt:message   var="title" key="Contact.Organization.User.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/User/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Admin.title" scope="request"/>
<c:set var="windowTitle" value="Contact.Organization.User.delete" scope="request"/>
