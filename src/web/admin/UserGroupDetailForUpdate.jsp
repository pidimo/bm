...
<c:set var="helpResourceKey" value="help.userGroup.edit" scope="request"/>

<fmt:message var="title" key="User.UserGroup.edit" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/User/UpdateUserGroup" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Contact.plural" scope="request"/>
<c:set var="windowTitle" value="User.UserGroup.edit" scope="request"/>
