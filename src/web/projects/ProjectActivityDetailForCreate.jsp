...
<c:set var="helpResourceKey" value="help.project.activity.create" scope="request"/>

<fmt:message var="title" key="ProjectActivity.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ProjectActivity/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="ProjectActivity.Title.create" scope="request"/>
