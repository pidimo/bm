...
<c:set var="helpResourceKey" value="help.project.timeLimit.edit" scope="request"/>

<fmt:message var="title" key="ProjectTimeLimit.title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ProjectTimeLimit/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="ProjectTimeLimit.title.update" scope="request"/>
