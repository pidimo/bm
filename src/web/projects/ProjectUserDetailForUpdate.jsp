...
<c:set var="helpResourceKey" value="help.project.assigneed.edit" scope="request"/>

<fmt:message var="title" key="ProjectAssignee.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ProjectUser/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="ProjectAssignee.Title.update" scope="request"/>
