...
<c:set var="helpResourceKey" value="help.project.time.delete" scope="request"/>

<fmt:message var="title" key="ProjectTime.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/ProjectTime/Delete" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="body" value="/WEB-INF/jsp/projects/ProjectTime.jsp" scope="request"/>
        <c:import url="/WEB-INF/jsp/layout/ui/main.jsp"/>
    </c:when>
    <c:otherwise>
        <c:set var="tabs" value="/ProjectTabs.jsp" scope="request"/>
        <c:set var="body" value="/common/projects/ProjectTime.jsp" scope="request"/>
