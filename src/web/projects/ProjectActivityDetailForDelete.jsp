...
<c:set var="helpResourceKey" value="help.project.activity.delete" scope="request"/>

<fmt:message var="title" key="ProjectActivity.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/ProjectActivity/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="ProjectActivity.Title.delete" scope="request"/>
