...
<c:set var="helpResourceKey" value="help.report.role.delete" scope="request"/>

<fmt:message var="title" key="ReportRole.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/ReportRole/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="ReportRole.delete" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="body" value="/WEB-INF/jsp/reports/ReportRole.jsp" scope="request"/>
    ...
    <c:otherwise>
        ...
        <c:set var="body" value="/common/reports/ReportRole.jsp" scope="request"/>
