...
<c:set var="helpResourceKey" value="help.report.role.add" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="body" value="/WEB-INF/jsp/reports/ReportRoleImportList.jsp" scope="request"/>
    ...
    <c:otherwise>
        ...
        <c:set var="body" value="/common/reports/ReportRoleImportList.jsp" scope="request"/>
