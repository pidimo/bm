...
<fmt:message var="title" key="MailAccount.title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/MailAccount/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="MailAccount.title.create" scope="request"/>
