...
<c:set var="helpResourceKey" value="help.mail.send.relatedToCommunicationsOf" scope="request"/>
...
<c:set var="action" value="/Mail/CreateEmailCommunicationAfterSend.do" scope="request"/>
