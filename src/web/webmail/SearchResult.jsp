...
<c:set var="helpResourceKey" value="help.mail.tray.search" scope="request"/>

<c:remove var="index" scope="session"/>
<c:set var="windowTitle" value="Webmail.search.searchResults" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="mailBody" value="/WEB-INF/jsp/webmail/SearchResult.jsp" scope="request"/>
    ...
    <c:otherwise>
        ...
        <c:set var="mailBody" value="/common/webmail/SearchResult.jsp" scope="request"/>
