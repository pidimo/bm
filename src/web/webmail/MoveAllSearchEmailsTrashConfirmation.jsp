...
<c:set var="action" value="/Mail/MoveAllSearchEmailsConfirmation.do" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        <c:set var="body" value="/WEB-INF/jsp/webmail/MoveAllSearchEmailsTrashConfirmation.jsp" scope="request"/>
        <c:import url="/WEB-INF/jsp/layout/ui/main.jsp"/>
    </c:when>
    <c:otherwise>
        <c:set var="body" value="/common/webmail/MoveAllSearchEmailsTrashConfirmation.jsp" scope="request"/>
