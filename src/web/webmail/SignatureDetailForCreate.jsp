...
<c:set var="helpResourceKey" value="help.mail.signature.create" scope="request"/>

<fmt:message  var="title" key="Webmail.signature.new" scope="request"/>
<fmt:message  var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/Mail/CreateSignature" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="Webmail.signature.new" scope="request"/>
<c:set var="pagetitle" value="Webmail.signature.plural" scope="request"/>
