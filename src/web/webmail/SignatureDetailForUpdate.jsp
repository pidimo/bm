...
<c:set var="helpResourceKey" value="help.mail.signature.edit" scope="request"/>

<fmt:message  var="title" key="Webmail.signature.edit" scope="request"/>
<fmt:message  var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/Mail/UpdateSignature" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="Webmail.signature.edit" scope="request"/>
