...
<c:set var="helpResourceKey" value="help.mail.contactGroup.update" scope="request"/>

<fmt:message  var="title" key="Webmail.contactGroup.edit" scope="request"/>
<fmt:message  var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/Mail/UpdateContactGroup" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="Webmail.contactGroup.edit" scope="request"/>
