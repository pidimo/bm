...
<c:set var="helpResourceKey" value="help.mail.account.delete" scope="request"/>

<fmt:message var="title" key="MailAccount.title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/MailAccount/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="MailAccount.title.delete" scope="request"/>
