...
<c:set var="helpResourceKey" value="help.mail.tray.list" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="mailBody" value="/WEB-INF/jsp/webmail/MailTray.jsp" scope="request"/>
    ...
    <c:otherwise>
        ...
        <c:set var="mailBody" value="/common/webmail/MailTray.jsp" scope="request"/>
