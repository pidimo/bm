...
<c:set var="helpResourceKey" value="help.mail.tray.communication.relatedToCommunicationsOf" scope="request"/>
...
<c:set var="action" value="/Mail/CreateEmailCommunication.do" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="mailBody" value="/WEB-INF/jsp/webmail/EmailCommunication.jsp" scope="request"/>
    ...
    <c:otherwise>
        ...
        <c:set var="mailBody" value="/common/webmail/EmailCommunication.jsp" scope="request"/>
