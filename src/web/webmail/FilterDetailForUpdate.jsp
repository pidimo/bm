...
<c:set var="helpResourceKey" value="help.mail.filter.edit" scope="request"/>

<fmt:message  var="title" key="Webmail.filter.update" scope="request"/>
<fmt:message  var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/Mail/UpdateFilter" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="Webmail.filter.update" scope="request"/>
