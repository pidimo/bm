...
<html:form action="${action}" focus="dto(projectId)" styleId="projectTimeRegistrationId" styleClass="form-horizontal">
    ...
    <div class="${app2:getFormClasses()}">
                ...
                <c:if test="${not empty projectTimeRegistrationForm.dtoMap['projectId']}">
                    ...
                    <c:if test="${'update' == op || 'delete' == op}">
                        <c:set var="toBeInvoiced" value="${projectTimeRegistrationForm.dtoMap['toBeInvoiced']}"
                               scope="request"/>
                        <c:set var="projectTimeStatus" value="${projectTimeRegistrationForm.dtoMap['status']}"
                               scope="request"/>
                        ...
                        <c:set var="assigneeId" value="${projectTimeRegistrationForm.dtoMap['assigneeId']}"
                               scope="request"/>
                    </c:if>
        ...
        <div class="${app2:getFormPanelClasses()}">
            ...
            <div class="${app2:getFormGroupClasses()}">
                <label class="${app2:getFormLabelClasses()}" for="projectId_id">
            ...
            <c:if test="${not empty projectTimeRegistrationForm.dtoMap['projectId']}">
                ...
                <div class="${app2:getFormGroupClasses()}">
                    <label class="${app2:getFormLabelClasses()}" for="assigneeId_key">
                ...
                <div class="${app2:getFormGroupClasses()}">
                    ...
                    <label class="${app2:getFormLabelClasses()}" for="fromHour_id">
                                    ...
                                    <div class="col-xs-9 ">
                                        <div class="input-group">
                                            <html:select property="dto(fromHour)" styleId="fromHour_id"
                                                         ...
                                                         onkeyup="fromHourChange()" tabindex="4"
                                                         styleClass="select ${app2:getFormSelectClasses()}"
                                                         readonly="${'delete' == op || !canEditPage}" style="border-radius: 4px;">
                                                <html:option value="">&nbsp;</html:option>
                                                <html:options collection="hourList" property="value"
                                                              labelProperty="label"/>
                                            </html:select>
                                            <span class="${showAddonMode ? '' : 'input-group-addon'}" style="border: 0px;background-color: transparent">:</span>
                ...
                <div class="${app2:getFormGroupClasses()}">
                    <label class="${app2:getFormLabelClasses()}" for="time_id">
                ...
                <div class="${app2:getFormGroupClasses()}">
                    <label class="${app2:getFormLabelClasses()}" for="toBeInvoiced_key">
                ...
                <div class="${app2:getFormGroupClasses()}">
                    <label class="${app2:getFormLabelClasses()}" for="subProjectId_key">
...
<tags:jQueryValidation formName="projectTimeRegistrationForm"/>
