...
<c:if test="${'forwardToCreate' == operation && app2:hasProjectUserPermission(projectId,'NEW',pageContext.request)}">
    <html:form action="/ProjectTime/Forward/Create.do" styleClass="form-horizontal">
            <html:submit styleClass="button ${app2:getFormButtonClasses()} marginButton" property="newButton">
