    ...
    <div class="${app2:getFormClasses()}">
        <div class="row">
            <div class="col-xs-12">
                ...
                <c:if test="${'update' == op || 'delete' == op}">
                    <c:set var="toBeInvoiced" value="${projectTimeForm.dtoMap['toBeInvoiced']}" scope="request"/>
                    <c:set var="projectTimeStatus" value="${projectTimeForm.dtoMap['status']}" scope="request"/>
                    <c:set var="projectStatus" value="${projectTimeForm.dtoMap['projectStatus']}" scope="request"/>
                    <c:set var="userId" value="${projectTimeForm.dtoMap['userId']}" scope="request"/>
                    <c:set var="assigneeId" value="${projectTimeForm.dtoMap['assigneeId']}" scope="request"/>
                </c:if>
                <c:import url="/WEB-INF/jsp/projects/ProjectTimeButtonFragment.jsp"/>
                <html:cancel styleClass="button ${app2:getFormButtonCancelClasses()} marginButton" tabindex="24">
        ...
        <div class="${app2:getFormPanelClasses()}">
            <fieldset>
                ...
                <c:if test="${not empty projectTimeForm.dtoMap['createdDate']}">
                    ...
                    <div class="${app2:getFormGroupClasses()}">
                        ...
                        <div class="${app2:getFormContainClasses(null)}">
                            <c:set var="updateAssigneeField"
                                   value="${sessionUserId == projectTimeForm.dtoMap['userId']}"/>
                    ...
                    <div class="${app2:getFormGroupClasses()}">
                        ...
                        <div class="${app2:getFormContainClasses('delete' == op || !canEditPage)}">
                    ...
                    <div class="${app2:getFormGroupClasses()}">
                        <c:set var="showAddonMode" value="${'delete' == op || !canEditPage}"/>
                        <label class="${app2:getFormLabelClasses()}">
                            <fmt:message key="ProjectTime.fromToTime"/>
                        </label>

                        <div class="${app2:getFormContainClasses(showAddonMode)}">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 wrapperButton">
                                    <div class="row">
                                        <div class="col-xs-3 ${showAddonMode?'':'control-label'} text-right">
                                            <fmt:message key="ProjectTime.fromTime"/>
                                        </div>
                                        <div class="col-xs-9">
                                            <div class="input-group">
                                                <html:select property="dto(fromHour)" styleId="fromHour_id"
                                                             onchange="fromHourChange()" onkeyup="fromHourChange()"
                                                             tabindex="4"
                                                ...
                                                <span class="${showAddonMode ? '' : 'input-group-addon'}"
                                                      style="border: 0px;background-color: transparent">:</span>
                                                <html:select property="dto(fromMin)" styleId="fromMin_id"
                                                             onchange="generalTimeChange()"
                                                             onkeyup="generalTimeChange()"
                                                             styleClass="select ${app2:getFormSelectClasses()}"
                                                             tabindex="4" readonly="${'delete' == op || !canEditPage}"
                                                             style="border-radius: 4px;">
                                                    <html:option value="">&nbsp;</html:option>
                                                    <html:options collection="minutesList" property="value"
                                                                  labelProperty="label"/>
                                                </html:select>
                                            </div>
                                            <span class="glyphicon form-control-feedback iconValidation"></span>
                                ...
                                <div class="col-xs-12 col-sm-6 wrapperButton">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="input-group">
                                                    <html:select property="dto(toHour)" styleId="toHour_id"
                                                                 onchange="generalTimeChange()"
                                                                 onkeyup="generalTimeChange()" tabindex="4"
                                                                 styleClass="select ${app2:getFormSelectClasses()}"
                                                                 readonly="${'delete' == op || !canEditPage}"
                                                                 style="border-radius: 4px;">
                                                        <html:option value="">&nbsp;</html:option>
                                               ...
                                               <span class="${showAddonMode ? '' : 'input-group-addon'}"
                                                     style="border: 0px;background-color: transparent">:</span>
                                                    <html:select property="dto(toMin)" styleId="toMin_id"
                                                                 onchange="generalTimeChange()"
                                                                 onkeyup="generalTimeChange()"
                                                                 styleClass="select ${app2:getFormSelectClasses()}"
                                                                 tabindex="4"
                    ...
                    <div class="${app2:getFormGroupClasses()}">
                        ...
                        <div class="${app2:getFormContainClasses(null)}">
                            ...
                            <c:if test="${true == projectTimeForm.dtoMap['disableInvoiceable']}">
                            ...
                            <div class="radiocheck">
                                <div class="checkbox checkbox-default">
                                    <html:checkbox property="dto(toBeInvoiced)"
                                                   ...
                                                   styleClass="radio"
                                                   disabled="${op == 'delete' || true == projectTimeForm.dtoMap['disableInvoiceable'] || !canEditPage}"
                                                   tabindex="6"
                                                   value="true">
                                        <label for="toBeInvoiced_key"></label>
                                    </html:checkbox>
                                    <span class="glyphicon form-control-feedback iconValidation"></span>
                                </div>
                            </div>
                ...
                <c:if test="${confirmedStatus == projectTimeForm.dtoMap['status'] || invoicedStatus == projectTimeForm.dtoMap['status'] || not_confirmedStatus == projectTimeForm.dtoMap['status']}">
                ...
                <c:if test="${not empty projectTimeForm.dtoMap['releasedUserId']}">
        ...
        <div class="row">
            <div class="col-xs-12">
                <c:set var="operation" value="${op}" scope="request"/>
                <c:set var="projectId" value="${param.projectId}" scope="request"/>
                <c:set var="tabIndex" value="12" scope="request"/>
                <c:if test="${'update' == op  || 'delete' == op}">
                    <c:set var="toBeInvoiced" value="${projectTimeForm.dtoMap['toBeInvoiced']}" scope="request"/>
                    <c:set var="projectTimeStatus" value="${projectTimeForm.dtoMap['status']}" scope="request"/>
                    <c:set var="userId" value="${projectTimeForm.dtoMap['userId']}" scope="request"/>
...
<tags:jQueryValidation formName="projectTimeForm"/>
