...
<html:form action="/Support/State/Translate/Save.do" styleClass="form-horizontal translate">
    <div class="${app2:getFormClasses()}">
        ...
        <div class="${app2:getFormPanelClasses()}">
            <fieldset>
                <legend class="title">
                    <fmt:message key="State.Title.translate"/>
                </legend>
            </fieldset>
            <div class="table-responsive">
                <table class="${app2:getTableClasesIntoForm()}">
                    ...
                    <tr>
                        <th>
                            <fmt:message key="State.translation"/>
                        </th>
                        <th>
                            <fmt:message key="State.language"/>
                        </th>
                        <th>
                            <fmt:message key="State.defaultTranslation"/>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach var="langText" items="${stateTranslateForm.dtoMap['translatedSystemLanguages']}"
                               varStatus="counter">
                        <tr>
                            <td>
...
<tags:jQueryValidation formName="stateTranslateForm"/>
