    ...
    <div class="${app2:getFormClasses()}">
            ...
            <fieldset>
                ...
                <div class="${app2:getFormGroupClasses()}">
                    <label class="${app2:getFormLabelClasses()}" for="languageId_id">
                        <fmt:message key="ReminderText.language"/>
                    </label>
                    <c:choose>
        ...
        <div class="${app2:getFormButtonWrapperClasses()}">
            <app2:checkAccessRight functionality="REMINDERLEVEL" permission="UPDATE">
                <html:submit styleClass="${app2:getFormButtonClasses()}" tabindex="3">${button}</html:submit>
            </app2:checkAccessRight>
            <html:cancel styleClass="${app2:getFormButtonCancelClasses()}" tabindex="4"><fmt:message
                    key="Common.cancel"/></html:cancel>
        </div>
    </div>
</html:form>

<tags:jQueryValidation formName="reminderTextForm"/>
