...
<html:form action="/Support/CaseType/Translate/Save.do" styleClass="form-horizontal translate">
    <div class="${app2:getFormClasses()}">
        ...
        <div class="${app2:getFormPanelClasses()}">
            <fieldset>
                <legend class="title">
                    <fmt:message key="CaseType.Title.translate"/>
                </legend>
            </fieldset>
            ...
            <div class="table-responsive">
                <table class="${app2:getTableClasesIntoForm()}">
                    ...
                    <c:forEach var="langText"
                               items="${caseTypeTranslateForm.dtoMap['translatedSystemLanguages']}"
                               varStatus="counter">
                        <tr>
                            <td>
