    ...
    <div class="row">
        <div class="col-xs-12">
            <app2:securitySubmit operation="${op}" functionality="FILTER"
                                 styleClass="button ${app2:getFormButtonClasses()} marginButton">${button}</app2:securitySubmit>
            <c:if test="${op == 'create'}">
                <app2:securitySubmit operation="${op}" functionality="FILTER"
            ...
            <div class="table-responsive table-responsive-filer">
                <table width="100%"
                    ...
                    <tr>
                        ...
                        <c:if test="${container=='false'}">
                            <td style="${createView}" width="25%">
                                <div class="form-group">
                                    <label class="control-label label-left col-xs-12" for="">
                        ...
                        <td class="${containTop}" width="75%" style="min-width: 300px; vertical-align: super">
                            <c:choose>
                            ...
                            <div id="filterView" style="${displayFilter}">
                                <div style="${createView}">
                                    <label class="control-label label-left col-xs-12">
                                ...
                                <div class="${app2:getFormGroupClasses()}">
                                    ...
                                    <div class="${app2:getFormContainClasses(op == 'delete')}">
                                        ...
                                        <html:select property="dto(opSelect)" styleId="idOpBox" value="${operatorValue}"
                                                     ...
                                                     onkeyup="javascript:showView(this.form.idOpBox)"
                                                     readonly="${op == 'delete'}"
                                                     tabindex="2">
                                            <c:if test="${not empty tableRef && not empty columnRef}">
                                ...
                                <div class="${app2:getFormGroupClasses()}">
                                    ...
                                    <div id="bodyViewValue" class="${app2:getFormContainClasses(op == 'delete')}">
                                        <c:if test="${op == 'delete'}">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6 wrapperButton">
                                                    ...
                                                    <app:text property="dto(value1)"
                                                              styleClass="shortText numberText wrapperButton numberInputWidth ${app2:getFormInputClasses()}"
                                                              tabindex="3"
                                                              maxlength="100"/>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 wrapperButton">
                                        ...
                                        <div id="oneSelect" style="display:none;">
                                        ...
                                        <div id="mSelect" style="display:none;">
                                        ...
                                        <div id="oneBoxDate" style="display:none;">
                                            <div class="input-group date">
                                                <app:dateText property="dto(date)" styleId="date"
                                                              calendarPicker="true"
                                                              mode="bootstrap"
                                        ...
                                        <div id="twoBoxDate" style="display:none;">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6 wrapperButton">
                                                    <fmt:message var="from" key="Report.filter.from"/>
                                                    <div class="input-group date">
                                                        <app:dateText property="dto(date1)"
                                                                      placeHolder="${from}"
                                                                      mode="bootstrap"
                                                                      styleId="date1" calendarPicker="true"
                                                                      datePatternKey="${datePattern}"
                                                ...
                                                <div class="col-xs-12 col-sm-6 wrapperButton">
                                                    ...
                                                    <div class="input-group date">
                                                        <app:dateText property="dto(date2)"
                                                                      placeHolder="${to}"
                                                                      mode="bootstrap"
                                                                      styleId="date2" calendarPicker="true"
                                                                      datePatternKey="${datePattern}"
                                                                      styleClass="shortText ${app2:getFormInputClasses()}"
                                                                      view="${op == 'delete'}"
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <c:if test="${op == 'create'}">
                <app2:securitySubmit operation="${op}" functionality="FILTER"
                                     styleClass="button ${app2:getFormButtonClasses()} marginButton"
                                     property="SaveAndNew" tabindex="11"><fmt:message
                        key="Common.saveAndNew"/></app2:securitySubmit>
            </c:if>
            <html:cancel styleClass="button ${app2:getFormButtonCancelClasses()} marginButton"
                         tabindex="12"><fmt:message key="Common.cancel"/></html:cancel>
        </div>
    </div>
    <c:if test="${container=='true'}">
        </div>
...
<c:if test="${container=='true'}">
    <tags:jQueryValidation formName="filterCreateForm"/>
</c:if>
