...
<html:form action="${action}${urlReportId}" focus="dto(newReportTitle)" styleClass="form-horizontal">
    ...
    <div class="${app2:getFormButtonWrapperClasses()}">
        <c:choose>
            <c:when test="${isExternalModule}">
                <html:submit styleClass="${app2:getFormButtonClasses()}" tabindex="1">
                    <fmt:message key="EXECUTE"/>
                </html:submit>
            </c:when>
            <c:otherwise>
                <app2:securitySubmit operation="EXECUTE" functionality="REPORT"
    ...
    <div class="${app2:getFormPanelClasses()}" id="Filter.jsp">
        <legend class="title">
        ...
        <div class="row">
            <div class="${app2:getFormGroupClassesTwoColumns()}">
                <label class="${app2:getFormLabelClassesTwoColumns()}" for="newReportTitle_id">
                    <fmt:message key="ReportGenerator.reportTitle"/>
                </label>

                <div class="${app2:getFormContainClassesTwoColumns(null)}">
                    <html:text property="dto(newReportTitle)"
                               styleId="newReportTitle_id"
        ...
        <div class="row">
            <div class="${app2:getFormGroupClassesTwoColumns()}">
                ...
                <div class="${app2:getFormContainClassesTwoColumns(null)}">
                    <c:set var="pageSizes" value="${app2:getReportPageSizes(pageContext.request)}"
                           scope="request"/>
                    <html:select property="dto(pageSize)"
                                 styleId="pageSize"
                                 styleClass="mediumSelect ${app2:getFormSelectClasses()}"
                                 tabindex="3">
                        <html:options collection="pageSizes" property="pageSize"
                                      labelProperty="pageSizeName"/>
                    </html:select>
                </div>
            </div>
            ...
            <div class="${app2:getFormGroupClassesTwoColumns()}">
                ...
                <div class="${app2:getFormContainClassesTwoColumns(null)}">
                    <c:set var="pageOrientations"
                           value="${app2:getReportPageOrientations(pageContext.request)}"
                           scope="request"/>
                    <html:select property="dto(pageOrientation)"
                                 styleId="pageOrientation"
                                 styleClass="mediumSelect ${app2:getFormSelectClasses()}"
                                 tabindex="4">
        ...
        <div class="row"
             id="csvSettingId" ${reportExecuteForm.dtoMap['reportFormat'] eq CSV_FORMAT ? "" : "style=\"display: none;\""}>
            <div class="${app2:getFormGroupClassesTwoColumns()}">
                <label class="${app2:getFormLabelClassesTwoColumns()}" for="reoportCharset_id">
            ...
            <div class="${app2:getFormGroupClassesTwoColumns()}">
                <label class="${app2:getFormLabelClassesTwoColumns()}" for="csvDelimiter_id">
                        ...
                        <div class="${app2:getFormContainClasses(false)}">
                            ...
                            <div class="${app2:getFormContainClasses(null)}">
                                ...
                                <div id="mSelect${idF}" style="display:none;">
                                    <html:hidden property="dto(multipleSelect${idF})"
                                                 styleId="idMultiple${idF}"/>
                                    <html:select property="multipleSelect${idF}"
                                                 styleId="mSelectId${idF}"
                                                 value=""
                                ...
                                <div id="oneBoxDate${idF}" style="display:none;">
                                    <div class="input-group date">
                                        <app:dateText property="dto(date${idF})"
                                                      styleId="date${idF}"
                                                      mode="bootstrap"
                                                      calendarPicker="true"
                                ...
                                <div id="twoBoxDate${idF}" style="display:none;">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 wrapperButton">
                                            ...
                                            <div class="input-group date">
                                                <app:dateText property="dto(date1${idF})"
                                                              styleId="date1${idF}"
                                                              calendarPicker="true"
                                                              mode="bootstrap"
                                                              placeHolder="${from}"
                                        ...
                                        <div class="col-xs-12 col-sm-6 wrapperButton">
                                            ...
                                            <div class="input-group date">
                                                <app:dateText property="dto(date2${idF})"
                                                              styleId="date2${idF}"
                                                              mode="bootstrap"
                                                              placeHolder="${to}"
                                                              calendarPicker="true"
                                ...
                                <div id="popup${idF}" style="display:none;">
                                    ...
                                    <div class="input-group">
                                        <app:text property="dto(popupValue${idF})"
                                                  styleId="popupValue${idF}"
                                                  styleClass="text ${app2:getFormInputClasses()}"
                                                  readonly="true"
                                                  tabindex="6"/>
                                        <span class="input-group-btn">
                                            <tags:bootstrapSelectPopup url="/reports/Report/Filter/ImportDBFilter.do"
                                                                       name="${idF}"
