...
<html:form action="${action}" focus="listColumns" styleClass="form-horizontal">
    ...
    <div class="${app2:getFormButtonWrapperClasses()}">
        <app2:checkAccessRight functionality="COLUMN" permission="UPDATE">
            <html:submit onclick="javascript:send(this.form.listColumns)"
                         styleClass="button ${app2:getFormButtonClasses()}">${button}</html:submit>
                    ...
                    <tr>
                        <td class="containTop">
                            ...
                            <c:forEach var="item" items="${labelValueColumns}" varStatus="x">
                                <html:hidden property="previousColumns" value="${item.value}"
                                             styleId="preColId${x.index}"/>
                            </c:forEach>
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <html:select property="listColumns" styleId="listColumnsId" multiple="true"
                                                 style="height: 100%"
                                                 size="15" styleClass="multipleColumnSelect ${app2:getFormSelectClasses()}"
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-md-3 control-label" for="">
                                            <fmt:message key="Report.columns.label"/>
                                        </label>

                                        <div class="col-xs-12 col-md-9">
                                            <app:text property="label" value=""
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-md-9">
                                            <html:select property="columnOrder" value=""
                                                         styleClass="shortSelect ${app2:getFormSelectClasses()}"
                                                         onchange="javascript:setColumnOrder()"
                                                         onkeyup="javascript:setColumnOrder()" tabindex="2">
                                                <option></option>
                        ...
                        <td class="containTop">
                            <table cellpadding="2" cellspacing="0">
                                <tr>
                                    <td>
                                        <input type="button" value="&#xf176;" onclick="moveUpList(this.form.listColumns)"
                                               name="B5" class="fa fa-lg adminUpArrow ${app2:getFormButtonClasses()}"
                                               title="<fmt:message key="Common.up"/>"
                                               tabindex="3"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input type="button" value="&#xf175;" onclick="moveDownList(this.form.listColumns)"
                                               name="B5" class="fa fa-lg adminDownArrow ${app2:getFormButtonClasses()}"
                                               title="<fmt:message key="Common.down"/>"
                                               tabindex="4"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input type="button" value="&#xf00d;" onclick="removeSelectedColumn(this.form.listColumns)"
                                               name="B1"
                                               class="fa removeButton ${app2:getFormButtonCancelClasses()}"
                        ...
                        <td>
                            <div>
                                ...
                                <c:set var="ajaxUrlExecute" value="/reports/Report/Forward/TreeColumns.do"
                                       scope="request"/>
