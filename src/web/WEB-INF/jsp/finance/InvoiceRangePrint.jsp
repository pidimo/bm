...
<div class="${app2:getListWrapperClasses()}">
    ...
    <html:form action="/Invoice/RangePrintList.do"
        ...
        <div class="${app2:getAlphabetWrapperClasses()}">
            <fanta:alphabet action="/Invoice/RangePrintList.do" parameterName="alphabetName1" mode="bootstrap"/>
        </div>
    </html:form>
    ...
    <html:form action="/Invoice/RangePrint.do" styleId="formList"
               onsubmit="return testSubmit();">
        <html:hidden property="dto(printAllIds)" value="${allPrintIds}" styleId="printAll_id"/>
        ...
        <div class="table-responsive">
            <fanta:table mode="bootstrap" list="invoicePrintList"
