        ...
        <div class="${app2:getFormPanelClasses()}">
            ...
            <div class="row">
                ...
                <div class="${app2:getFormGroupClassesTwoColumns()}">
                    ...
                    <div class="${app2:getFormContainClassesTwoColumns('delete' == op || true == salePositionForm.dtoMap['salePositionHasInvoiced'])}">
                        <c:set var="hidenPopup" value="${'delete' == op || true == salePositionForm.dtoMap['salePositionHasInvoiced']}"/>

                        <div class="${hidenPopup ? "" : "input-group" }">
                        ...
                        <span class="${hidenPopup ? "pull-right" : "input-group-btn" }">
                            <app2:checkAccessRight functionality="PRODUCT" permission="VIEW">
                                <c:if test="${'update' == op && not empty salePositionForm.dtoMap['productId']}">
                                    ...
                                    <app:link action="${productEditLink}"
                                              ...
                                              tabindex="2"
                                              styleClass="${hidenPopup ? '' : app2:getFormButtonClasses()}" titleKey="Common.edit">
                    ...
                    <div class="row">
                        ...
                        <div class="${app2:getFormGroupClassesTwoColumns()}">
                            ...
                            <div class="${app2:getFormContainClassesTwoColumns('delete' == op || false == salePositionForm.dtoMap['canChangePayMethod'])}">
                                <c:set var="payMethodList"
                                       value="${app2:getSalePositionPayMethods(pageContext.request)}"/>
            ...
            <c:if test="${empty salePositionSubCategoriesAjaxAction}">
                <c:set var="salePositionSubCategoriesAjaxAction"
                       value="/contacts/SalePosition/MainPageReadSubCategories.do"
                       scope="request"/>
            </c:if>
