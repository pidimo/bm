...
<div class="table-responsive">
    <fanta:table mode="bootstrap" list="activityUserList" align="left"
                 styleClass="${app2:getFantabulousTableClases()}"
                 width="100%" id="actUser"
        ...
        <fanta:columnGroup title="Common.action" headerStyle="listHeader" width="5%">
            <app2:checkAccessRight functionality="ACTIVITYUSER" permission="VIEW">
                <fanta:actionColumn useJScript="true"
                                    action="javascript:getUpdateUrl('${actUser.activityId}','${actUser.userId}','${app2:jscriptEncode(actUser.userName)}')"
                                    title="Common.update"
                                    styleClass="listItem" headerStyle="listHeader" width="50%"
                                    glyphiconClass="${app2:getClassGlyphEdit()}" name="upd" label="Common.update">
                </fanta:actionColumn>
            </app2:checkAccessRight>
            <app2:checkAccessRight functionality="ACTIVITYUSER" permission="DELETE">
                <fanta:actionColumn useJScript="true"
                                    action="javascript:getDeleteUrl('${actUser.activityId}','${actUser.userId}','${app2:jscriptEncode(actUser.userName)}')"
                                    title="Common.delete"
                                    styleClass="listItem" headerStyle="listHeader" width="50%"
        ...
        <fanta:dataColumn name="userName" useJScript="true"
                          action="javascript:getUpdateUrl('${actUser.activityId}','${actUser.userId}','${app2:jscriptEncode(actUser.userName)}')"
                          styleClass="listItem" title="Campaign.activity.campContact.assign.responsible"
                          headerStyle="listHeader" width="80%"
                          orderable="true"/>

        <fanta:dataColumn name="percent" styleClass="listItem2" title="Campaign.activity.user.percent"
...
<span class="pull-right">
    ...
    <fmt:message key="Campaign.activity.user.automaticAssign.totalPercent"/>:&nbsp;${sumPrct}
