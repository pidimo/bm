...
<a href="<%= urlRoute %>" target="_blank">
    <i class="fa fa-map-o map-icon" title="<fmt:message key="Contact.map24.traceRoute"/>"></i>
</a>
<% } else {%>
<i class="fa fa-map-o map-icon disabled" title="<fmt:message key="Contact.map24.traceRoute"/>"></i>
<% } %>