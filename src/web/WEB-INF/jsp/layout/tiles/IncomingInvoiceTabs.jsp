...
<app2:checkAccessRight functionality="INCOMINGINVOICE" permission="VIEW">
    <c:set target="${tabItems}" property="Finance.IncomingInvoice.detail"
           value="/IncomingInvoice/Forward/Update.do?dto(incomingInvoiceId)=${incomingInvoiceId}&dto(op)=read&incomingInvoiceId=${incomingInvoiceId}"/>
</app2:checkAccessRight>
<app2:checkAccessRight functionality="INCOMINGPAYMENT" permission="VIEW">
    <c:set target="${tabItems}" property="Finance.IncomingInvoice.incomingPayments"
           value="/IncomingPayment/List.do?dto(incomingInvoiceId)=${incomingInvoiceId}&incomingInvoiceId=${incomingInvoiceId}"/>
</app2:checkAccessRight>
