...
<c:set var="tabHeaderValue" scope="request">
    <fanta:label listName="lightReportList" module="/reports" patron="0" columnOrder="reportName">
        <fanta:parameter field="companyId"
                         value="${not empty reportCompanyId ? reportCompanyId : sessionScope.user.valueMap['companyId']}"/>
...
<app2:checkAccessRight functionality="JRXMLREPORT" permission="EXECUTE">
    <c:set target="${tabItems}" property="EXECUTE"
           value="/Report/Jrxml/Forward/Execute.do?dto(reportId)=${param.reportId}"/>
</app2:checkAccessRight>
