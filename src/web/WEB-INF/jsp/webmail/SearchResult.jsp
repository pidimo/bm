...
<html:form action="/Mail/SearchResult.do" styleId="searchMailFormX" onsubmit="return testSubmit()">
    <div id="SearchResult.jsp" class="wrapperSearch">
        ...
        <div id="SearchResult.jsp">
            ...
            <div class="col-xs-6 col-sm-3 col-md-1 col-lg-1 pull-left paddingRemove">
                <div class="col-xs-4 paddingRemove">
                    ...
                    <html:link styleClass="btn btn-link" titleKey="Webmail.moveToTrash" href="#"
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <label class="control-label col-xs-4 col-sm-7 paddingLeftRemove form-control-static" style="text-align: right;">
    ...
    <div class="table-responsive">
        <fanta:table mode="bootstrap" list="searchMailList" width="100%" id="mailList"
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <span class="${app2:getClassGlyphSave()}"
                                              title="Webmail.folder.show.from"></span>
                                    </c:otherwise>
                                </c:choose>
                            </c:if>
            ...
            <fanta:dataColumn name="" styleClass="listItemCenter" title="Webmail.tray.attach"
                              headerStyle="listHeader"
                              width="3%" renderData="false"
            ...
            <fanta:dataColumn name="MAILSUBJECT" action="${mailAction}" styleClass="listItem"
                              ...
                              headerStyle="listHeader" renderData="false" width="33%" orderable="true">
