...
<c:if test="${null != form.dtoMap['smtpErrorMessages']}">
    <c:set var="smtp_authentication"
           value="<%=WebMailConstants.EmailAccountErrorType.SMTP_AUTHENTICATION.getConstantAsString()%>"/>
    ...
    <c:set var="smtp_sendFail"
           value="<%=WebMailConstants.EmailAccountErrorType.SMTP_SENDFAILED.getConstantAsString()%>"/>
