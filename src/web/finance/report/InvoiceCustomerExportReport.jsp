...
<c:set var="helpResourceKey" value="help.finances.report.invoiceCustomerOutgoing" scope="request"/>

<fmt:message var="title" key="Finance.report.invoiceCustomerExport" scope="request"/>
<c:set var="action" value="/Report/InvoiceCustomerExport/Execute" scope="request"/>
