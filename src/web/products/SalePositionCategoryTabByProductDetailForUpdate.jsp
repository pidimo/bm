...
<c:set var="action"
       value="/SalePosition/CategoryTab/Update.do?dto(salePositionId)=${param.salePositionId}&dto(categoryTabId)=${param.categoryTabId}&categoryTabId=${param.categoryTabId}"
       scope="request"/>

<c:set var="ajaxAction" value="/products/SalePosition/ReadSubCategories.do" scope="request"/>

<c:set var="downloadAction"
       value="/products/SalePosition/DownloadCategoryFieldValue.do?dto(salePositionId)=${param.salePositionId}&salePositionId=${param.salePositionId}&dto(categoryTabId)=${param.categoryTabId}&categoryTabId=${param.categoryTabId}&index=${param.index}"
       scope="request"/>
