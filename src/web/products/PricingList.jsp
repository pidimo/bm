...
<c:set var="windowTitle" value="Pricing.Title" scope="request"/>
<c:set var="pagetitle" value="Product.plural" scope="request"/>

<c:set var="helpResourceKey" value="help.product.pricing.list" scope="request"/>

<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        <c:set var="body" value="/WEB-INF/jsp/products/PricingList.jsp" scope="request"/>
    ...
    <c:otherwise>
        ...
        <c:set var="body" value="/common/products/PricingList.jsp" scope="request"/>
