...
<c:set var="helpResourceKey" value="help.config.general.sequenceRule.edit" scope="request"/>

<fmt:message var="title" key="SequenceRule.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/SequenceRule/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="SequenceRule.Title.update" scope="request"/>
