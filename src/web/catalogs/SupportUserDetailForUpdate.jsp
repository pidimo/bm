...
<c:set var="helpResourceKey" value="help.config.support.supportUser.edit" scope="request"/>

<fmt:message var="title" key="SupportUser.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Support/User/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="SupportUser.Title.update" scope="request"/>
