...
<c:set var="helpResourceKey" value="help.config.general.categoryGroup.create" scope="request"/>

<fmt:message var="title" key="CategoryGroup.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/CategoryGroup/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="CategoryGroup.Title.create" scope="request"/>
