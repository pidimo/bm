...
<c:set var="helpResourceKey" value="help.config.customer.payMorality.delete" scope="request"/>

<fmt:message    var="title" key="PayMorality.Title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="PayMorality/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="PayMorality.Title.create" scope="request"/>
