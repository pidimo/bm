...
<c:set var="helpResourceKey" value="help.config.finances.vatRate.delete" scope="request"/>

<fmt:message    var="title" key="VatRate.Title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/VatRate/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="VatRate.Title.delete" scope="request"/>
