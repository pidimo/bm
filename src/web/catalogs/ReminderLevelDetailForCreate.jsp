...
<c:set var="helpResourceKey" value="help.config.finances.reminderLevel.create" scope="request"/>

<fmt:message var="title" key="ReminderLevel.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ReminderLevel/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="ReminderLevel.Title.create" scope="request"/>
