...
<c:set var="helpResourceKey" value="help.config.contact.bank.delete" scope="request"/>

<fmt:message var="title" key="Bank.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Bank/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Bank.Title.delete" scope="request"/>
