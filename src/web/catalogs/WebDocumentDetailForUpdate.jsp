...
<c:set var="helpResourceKey" value="help.config.communication.webDocument.edit" scope="request"/>

<fmt:message var="title" key="WebDocument.title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/WebDocument/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="WebDocument.title.update" scope="request"/>
