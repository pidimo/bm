...
<c:set var="helpResourceKey" value="help.config.contact.country.create" scope="request"/>

<fmt:message var="title" key="Country.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Country/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Country.Title.create" scope="request"/>
