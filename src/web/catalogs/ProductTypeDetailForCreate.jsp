...
<c:set var="helpResourceKey" value="help.config.product.productType.create" scope="request"/>

<fmt:message    var="title" key="ProductType.Title.create" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ProductType/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="ProductType.Title.create" scope="request"/>
