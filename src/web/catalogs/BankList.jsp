...
<c:set var="helpResourceKey" value="help.config.contact.bank.list" scope="request"/>

<fmt:setBundle basename="com.piramide.elwis.web.resources.ApplicationResources"/>
<c:set var="windowTitle" value="Bank.plural" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="body" value="/WEB-INF/jsp/catalogs/BankList.jsp" scope="request"/>
        <c:import url="/WEB-INF/jsp/layout/ui/main.jsp"/>
    </c:when>
    <c:otherwise>
        <c:set var="body" value="/common/catalogs/BankList.jsp" scope="request"/>
