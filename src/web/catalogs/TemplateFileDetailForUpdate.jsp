...
<c:set var="helpResourceKey" value="help.config.communication.template.file.edit" scope="request"/>

<fmt:message var="title" key="TemplateFile.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/TemplateFile/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="TemplateFile.Title.update" scope="request"/>
