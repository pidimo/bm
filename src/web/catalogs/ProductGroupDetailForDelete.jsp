...
<c:set var="helpResourceKey" value="help.config.product.productGroup.delete" scope="request"/>

<fmt:message var="title" key="ProductGroup.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/ProductGroup/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="ProductGroup.Title.delete" scope="request"/>
