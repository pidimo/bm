...
<c:set var="helpResourceKey" value="help.config.finances.reminderLevel.delete" scope="request"/>

<fmt:message var="title" key="ReminderLevel.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/ReminderLevel/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="ReminderLevel.Title.delete" scope="request"/>
