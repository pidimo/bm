...
<c:set var="helpResourceKey" value="help.config.contact.country.edit" scope="request"/>

<fmt:message var="title" key="Country.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Country/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Country.Title.update" scope="request"/>
