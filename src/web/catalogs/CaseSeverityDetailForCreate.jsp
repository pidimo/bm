...
<c:set var="helpResourceKey" value="help.config.support.caseSeverity.create" scope="request"/>

<fmt:message var="title" key="CaseSeverity.title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Support/CaseSeverity/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="CaseSeverity.title.create" scope="request"/>
