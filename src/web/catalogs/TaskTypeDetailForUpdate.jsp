...
<c:set var="helpResourceKey" value="help.config.scheduler.taskType.edit" scope="request"/>

<fmt:message var="title" key="TaskType.title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/TaskType/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="TaskType.title.update" scope="request"/>
