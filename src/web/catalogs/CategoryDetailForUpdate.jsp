...
<c:set var="helpResourceKey" value="help.config.general.category.edit" scope="request"/>

<fmt:message    var="title" key="Category.Title.update" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Category/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Category.Title.update" scope="request"/>
