...
<c:set var="helpResourceKey" value="help.config.communication.template.file.create" scope="request"/>

<fmt:message var="title" key="TemplateFile.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/TemplateFile/Create" scope="request"/>
<c:set var="op" value="uploadFile" scope="request"/>
<c:set var="windowTitle" value="TemplateFile.Title.create" scope="request"/>
