...
<c:set var="helpResourceKey" value="help.config.communication.telecomType.edit" scope="request"/>

<fmt:message var="title" key="TelecomType.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/TelecomType/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="TelecomType.Title.update" scope="request"/>
