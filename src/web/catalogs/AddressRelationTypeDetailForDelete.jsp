...
<c:set var="helpResourceKey" value="help.config.contact.relationType.delete" scope="request"/>

<fmt:message    var="title" key="AddressRelationType.title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/AddressRelationType/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="AddressRelationType.title.delete" scope="request"/>
