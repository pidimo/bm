...
<c:set var="helpResourceKey" value="help.config.general.sequenceRule.create" scope="request"/>

<fmt:message var="title" key="SequenceRule.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/SequenceRule/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="windowTitle" value="SequenceRule.Title.create" scope="request"/>
