...
<c:set var="helpResourceKey" value="help.config.general.categoryGroup.delete" scope="request"/>

<fmt:message var="title" key="CategoryGroup.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/CategoryGroup/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="CategoryGroup.Title.delete" scope="request"/>
