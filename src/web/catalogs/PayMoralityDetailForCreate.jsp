...
<c:set var="helpResourceKey" value="help.config.customer.payMorality.create" scope="request"/>

<fmt:message    var="title" key="PayMorality.Title.create" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/PayMorality/Create" scope="request"/>
