...
<c:set var="helpResourceKey" value="help.config.scheduler.appointmentType.delete" scope="request"/>

<fmt:message var="title" key="AppointmentType.title.delete" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/AppointmentType/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="AppointmentType.title.delete" scope="request"/>
