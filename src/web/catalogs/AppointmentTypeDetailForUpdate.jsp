...
<c:set var="helpResourceKey" value="help.config.scheduler.appointmentType.edit" scope="request"/>

<fmt:message var="title" key="AppointmentType.title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/AppointmentType/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="AppointmentType.title.update" scope="request"/>
