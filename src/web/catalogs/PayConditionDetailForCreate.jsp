...
<c:set var="helpResourceKey" value="help.config.finances.payCondition.create" scope="request"/>

<fmt:message var="title" key="PayCondition.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/PayCondition/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="PayCondition.Title.create" scope="request"/>
