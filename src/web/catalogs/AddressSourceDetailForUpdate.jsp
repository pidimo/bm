...
<c:set var="helpResourceKey" value="help.config.customer.addressSource.edit" scope="request"/>

<fmt:message var="title" key="AddressSource.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/AddressSource/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="AddressSource.Title.update" scope="request"/>
