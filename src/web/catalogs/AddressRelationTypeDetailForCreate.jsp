...
<c:set var="helpResourceKey" value="help.config.contact.relationType.create" scope="request"/>

<fmt:message    var="title" key="AddressRelationType.title.create" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/AddressRelationType/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="AddressRelationType.title.create" scope="request"/>
