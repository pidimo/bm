...
<c:set var="helpResourceKey" value="help.config.product.productGroup.edit" scope="request"/>

<fmt:message var="title" key="ProductGroup.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/ProductGroup/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="ProductGroup.Title.update" scope="request"/>
