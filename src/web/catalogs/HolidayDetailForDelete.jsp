...
<c:set var="helpResourceKey" value="help.config.scheduler.holiday.delete" scope="request"/>

<fmt:message var="title" key="holiday.title.delete" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Holiday/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="holiday.title.delete" scope="request"/>
<c:choose>
