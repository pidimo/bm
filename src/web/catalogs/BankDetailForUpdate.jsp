...
<c:set var="helpResourceKey" value="help.config.contact.bank.edit" scope="request"/>

<fmt:message var="title" key="Bank.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Bank/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Bank.Title.update" scope="request"/>
