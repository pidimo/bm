...
<c:set var="helpResourceKey" value="help.config.finances.vatRate.edit" scope="request"/>

<fmt:message    var="title" key="VatRate.Title.update" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/VatRate/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="VatRate.Title.update" scope="request"/>
