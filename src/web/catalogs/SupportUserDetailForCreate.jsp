...
<c:set var="helpResourceKey" value="help.config.support.supportUser.create" scope="request"/>

<fmt:message var="title" key="SupportUser.title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Support/User/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="SupportUser.title.create" scope="request"/>
