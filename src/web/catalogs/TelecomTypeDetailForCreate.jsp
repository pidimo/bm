...
<c:set var="helpResourceKey" value="help.config.communication.telecomType.create" scope="request"/>

<fmt:message var="title" key="TelecomType.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/TelecomType/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="TelecomType.Title.create" scope="request"/>
