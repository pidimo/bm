...
<c:set var="helpResourceKey" value="help.config.sales.status.delete" scope="request"/>

<fmt:message var="title" key="Status.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/Status/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="Status.Title.delete" scope="request"/>
