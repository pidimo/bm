...
<c:set var="helpResourceKey" value="help.config.customer.priority.list" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Priority.plural" scope="request"/>
<c:set var="delete" value="Customer/Priority/Forward/Delete.do" scope="request"/>
<c:set var="edit" value="Customer/Priority/Forward/Update.do" scope="request"/>
<c:set var="create" value="Customer/Priority/Forward/Create.do" scope="request"/>
<c:set var="action" value="Customer/Priority/List.do" scope="request"/>
