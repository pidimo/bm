...
<c:set var="helpResourceKey" value="help.config.general.category.delete" scope="request"/>


<fmt:message    var="title" key="Category.Title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="Category/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Category.Title.delete" scope="request"/>
