...
<c:set var="helpResourceKey" value="help.config.finances.payCondition.delete" scope="request"/>

<fmt:message var="title" key="PayCondition.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="PayCondition/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="PayCondition.Title.delete" scope="request"/>
