...
<c:set var="helpResourceKey" value="help.config.product.productType.delete" scope="request"/>

<fmt:message    var="title" key="ProductType.Title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/ProductType/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="ProductType.Title.delete" scope="request"/>
