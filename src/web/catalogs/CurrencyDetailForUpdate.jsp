...
<c:set var="helpResourceKey" value="help.config.contact.currency.edit" scope="request"/>

<fmt:message    var="title" key="Currency.Title.update" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Currency/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Common.configuration" scope="request"/>
<c:set var="windowTitle" value="Currency.Title.update" scope="request"/>
