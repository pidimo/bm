...
<c:set var="helpResourceKey" value="help.contact.office.delete" scope="request"/>

<fmt:message var="title" key="Contact.Organization.Office.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Organization/Office/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Contact.plural" scope="request"/>
<c:set var="windowTitle" value="Contact.Organization.Office.delete" scope="request"/>
