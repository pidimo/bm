...
<c:set var="helpResourceKey" value="help.contact.bankAccount.edit" scope="request"/>

<fmt:message var="title" key="Contact.BankAccount.edit" scope="request"/>

<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/BankAccount/Update" scope="request"/>
<c:set var="op" value="update" scope="request"/>

<c:set var="pagetitle" value="Contact.plural" scope="request"/>
<c:set var="windowTitle" value="Contact.BankAccount.edit" scope="request"/>
