...
<c:set var="helpResourceKey" value="help.contact.organization.delete" scope="request"/>

<fmt:message    var="title" key="Organization.Title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Organization/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="windowTitle" value="Organization.Title.delete" scope="request"/>
