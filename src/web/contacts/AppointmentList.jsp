...
<c:set var="helpResourceKey" value="help.contact.appointment.list" scope="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:set var="body" value="/WEB-INF/jsp/contacts/AppointmentList.jsp" scope="request"/>
        <c:import url="/WEB-INF/jsp/layout/ui/main.jsp"/>
    </c:when>
    <c:otherwise>
        <c:set var="tabs" value="/ContactTabs.jsp" scope="request"/>
        <c:set var="body" value="/common/contacts/AppointmentList.jsp" scope="request"/>
