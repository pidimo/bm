...
<c:set var="helpResourceKey" value="help.contact.bankAccount.create" scope="request"/>

<fmt:message var="title" key="Contact.BankAccount.new" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/BankAccount/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="pagetitle" value="Contact.plural" scope="request"/>
<c:set var="windowTitle" value="Contact.BankAccount.new" scope="request"/>
