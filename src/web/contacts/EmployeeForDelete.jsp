...
<c:set var="helpResourceKey" value="help.contact.employee.delete" scope="request"/>

<fmt:message    var="title" key="Contact.Organization.Employee.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Organization/Employee/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Contact.plural" scope="request"/>
<c:set var="windowTitle" value="Contact.Organization.Employee.delete" scope="request"/>
