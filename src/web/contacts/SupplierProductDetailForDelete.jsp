...
<c:set var="helpResourceKey" value="help.contact.supplierProduct.delete" scope="request"/>

<fmt:message var="title" key="Product.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/SupplierProduct/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="Supplier.Title.delete" scope="request"/>
