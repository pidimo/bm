...
<c:set var="downloadAction"
       value="/contacts/SalePosition/DownloadCategoryFieldValue.do?dto(salePositionId)=${param.salePositionId}&salePositionId=${param.salePositionId}&dto(categoryTabId)=${param.categoryTabId}&categoryTabId=${param.categoryTabId}&index=${param.index}"
       scope="request"/>
