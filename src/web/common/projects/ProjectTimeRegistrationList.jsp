    ...
    <td>
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
            ...
            <TR>
                ...
                <html:form action="/ProjectTimeRegistration/List.do" focus="parameter(projectName)">
                    <td class="contain" nowrap>
                        ...
                        <app:link action="/Project/ProjectTimesAdvancedSearch.do">
            ...
            <tr>
                <td colspan="2" align="center" class="alpha">
                    <fanta:alphabet action="ProjectTimeRegistration/List.do" parameterName="projectNameAlpha"/>
                </td>
            </tr>
        </table>
        <br/>
...
<tr>
    <td align="center" colspan="2">
        <fanta:table list="projectTimeRegistrationList"
