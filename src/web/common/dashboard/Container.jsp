...
<script type="text/javascript">
    ...
    function concatText(text, xmlComponentId, dbComponentId, otherText) {
        var divElement = document.getElementById('component_' + xmlComponentId + '_' + dbComponentId);
        divElement.innerHTML = otherText + text;
    }
...
<table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;" width="950px" align="center" height="95%">
    <tr>
        <td valign="top">


            <%--<div class="dtree" style="width:950px;" align="center">--%>
            <div class="dtree" style="float:left; width:470px;">
                <c:forEach var="component" items="${left}">
                    ...
                    <app2:checkAccessRight functionality="${functionality}" permission="${permission}">
                        <div id="component_${component.xmlComponentId}_${component.componentId}" style="width:100%; overflow-x:auto;">
                                ${loadMSG}
                        </div>
                        <br/>
            ...
            <div class="dtree" style="float:right; width:470px;">
