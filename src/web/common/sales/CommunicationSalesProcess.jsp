            ...
            <tr>
                ...
                <td class="contain">
                    ...
                    <tags:selectPopup tabindex="5"
                                      url="/contacts/ContactPerson/Search.do?contactId=${param.addressId}"
                                      name="searchContactPerson"
                                      titleKey="Common.search" hide="${view}"
...
<TR>
    ...
    <TD class="contain">
        ...
        <html:select property="dto(probability)" styleClass="shortSelect"
    ...
    <tr>
        ...
        <td class="contain">
            <fanta:select property="dto(additionalAddressId)" listName="additionalAddressSelectList"
                ...
                <fanta:parameter field="addressId" value="${not empty mainCommunicationForm.dtoMap['addressId'] ? mainCommunicationForm.dtoMap['addressId'] : param.addressId}"/>
            </fanta:select>
        </td>
    </tr>
</c:if>
