...
<html:form action="/Communication/AdvancedSearch.do" focus="parameter(note)">
    <TR>
    ...
    <TR>
        <TD width="15%" class="label"><fmt:message key="ContactPerson.title"/></TD>
        <TD width="35%" class="contain">
            <html:hidden property="parameter(contactPersonId)" styleId="fieldContactPersonId_id"/>
            <app:text property="parameter(contactPersonName_field)" styleClass="mediumText"
                      readonly="true" styleId="fieldContactPersonName_id"/>

            <tags:selectPopup tabindex="2"
    ...
    <tr>
        <TD width="15%" class="label"><fmt:message key="SalesProcess"/></TD>
        <TD width="35%" class="contain">
            <html:text property="parameter(processName)" styleClass="mediumText" tabindex="5"/>
        </TD>
        <TD colspan="2" class="contain">&nbsp;</TD>
    </tr>
    <tr>
        <td colspan="4" align="center" class="alpha">
            <fanta:alphabet action="/Communication/AdvancedSearch.do" parameterName="noteAlpha"/>
        </td>
    </tr>
    <tr>
...
<tr>
    <td colspan="4" align="center">
        <fanta:table list="communicationAdvancedSearchList" width="100%" id="communication"
