...
<c:set var="TYPE_ORG_AND_CONTACTPERSON" value="<%=ContactConstants.ImportProfileType.ORGANIZATION_AND_CONTACT_PERSON.getConstant().toString()%>"/>
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <fanta:table list="importProfileList"
                         width="100%"
                         id="importProfile"
                ...
                <fanta:dataColumn name="label" action="${editLink}" styleClass="listItem" title="dataImport.configuration.name"
