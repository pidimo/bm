...
<br/>
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="searchContainer">
    <html:form action="/AppointmentList.do" focus="parameter(title)">
        <TR>
            <td class="label">
            ...
            <td class="contain" nowrap>
                ...
                &nbsp;
                <html:submit styleClass="button" tabindex="2">
                    <fmt:message key="Common.go"/>
                </html:submit>
                &nbsp;
                <html:select property="parameter(stateFilter)" styleClass="select" tabindex="3">
        ...
        <tr>
            <td colspan="4" align="center" class="alpha">
                <fanta:alphabet action="AppointmentList.do" parameterName="titleAlphabet"/>
            </td>
        </tr>
    </html:form>
</table>
...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="container">
    <tr>
        <td align="center">
            ...
            <fanta:table width="100%" id="appointment" action="AppointmentList.do" imgPath="${baselayout}">
                <c:set var="timeZone"
