    ...
    <c:when test="${item.isContract}">
        ...
        <c:choose>
            <c:when test="${accessUpdateContract}">
                <app:link action="${eidtContractExtUrl}${urlParam}" contextRelative="${not empty isContextRelative}">
    ...
    <c:otherwise>
        ...
        <c:choose>
            <c:when test="${accessUpdateSalePosition}">
                <app:link action="${eidtSalePositionExtUrl}${urlParam}" contextRelative="${not empty isContextRelative}">
                    <c:out value="${failLabel}"/>
                </app:link>
            </c:when>
            <c:otherwise>
