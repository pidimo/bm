        ...
        <app2:checkAccessRight functionality="APPOINTMENTPARTICIPANT" permission="CREATE">
           ...
           <c:url var="url" value="/scheduler/AppointmentParticipant/Forward/Group/Create.do">
            ...
            <c:if test="${rightEditAppointment}">
                    ...
                    <html:button property="" styleClass="button" onclick="location.href='${url1}'" >
...
<fanta:table list="participantList" width="100%" id="participant" action="Appointment/ParticipantList.do?appointmentId=${param.appointmentId}&onlyView=${param.onlyView}&calendar=${param.calendar}&type=${param.type}" imgPath="${baselayout}">
