...
<%--CREATE, CANCEL, SAVE AND NEW buttons--%>
           <table cellSpacing=0 cellPadding=4 width="60%" border=0 align="center">
              <TR>
                  <TD class="button">
                  <app2:securitySubmit operation="${op}" functionality="SALESPROCESSPRIORITY" styleClass="button">${button}</app2:securitySubmit>
                  <c:if test="${op == 'create'}" >
                        <app2:securitySubmit operation="${op}" functionality="SALESPROCESSPRIORITY" styleClass="button" property="SaveAndNew"><fmt:message   key="Common.saveAndNew"/></app2:securitySubmit>
                  </c:if>
