...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <html:form action="${action}" focus="dto(severityName)">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="60%" align="center" class="container">
                    ...
                    <TR>
                        <TD class="label" width="25%" nowrap><fmt:message key="CaseSeverity.name"/></TD>
                        <TD class="contain" width="75%">
                            <app:text property="dto(severityName)" styleClass="largetext" maxlength="40"
                                      view="${'delete' == op}" tabindex="1"/>
                        </TD>
                    </TR>
                    <TR>
                        <TD class="label"><fmt:message key="CaseSeverity.sequence"/></TD>
                        <TD class="contain">
                    ...
                    <tr>
                        <td class="label"><fmt:message key="CaseSeverity.language"/></td>
                        <td class="contain">
                            <fanta:select property="dto(languageId)" listName="systemLanguageList" labelProperty="name"
                                          valueProperty="id"
                                          firstEmpty="true" styleClass="select" tabIndex="3"
                ...
                <table cellSpacing=0 cellPadding=4 width="60%" border=0 align="center">
                    <TR>
                        <TD class="button">
                            <app2:securitySubmit operation="${op}" functionality="CASESEVERITY" styleClass="button"
                                                 property="dto(save)" tabindex="4">
                                ${button}
                            </app2:securitySubmit>
                            <c:if test="${op == 'create'}">
                                <app2:securitySubmit operation="${op}" functionality="CASESEVERITY" styleClass="button"
                                                     property="SaveAndNew" tabindex="5"><fmt:message
