...
<tr>
    <td>
    <html:form action="/Support/CaseSeverity/Translate/Save.do">
        ...
        <tr>
            <td colspan="3" class="title"><fmt:message  key="CaseSeverity.Title.translate"/></td>
        </tr>
        <tr>
        ...
        <c:forEach var="langText" items="${caseSeverityTranslateForm.dtoMap['translatedSystemLanguages']}" varStatus="counter" >
        <tr>
