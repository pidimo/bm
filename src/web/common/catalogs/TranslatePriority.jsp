        ...
        <td>
            <html:form action="/Support/Priority/Translate/Save.do">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="container" width="100%" align="center">
                    <tr>
                        <td colspan="3" class="title"><fmt:message key="SupportPriority.Title.translate"/></td>
                    </tr>
                    <tr>
                    ...
                    <c:forEach var="langText" items="${supportPriorityTranslateForm.dtoMap['translatedSystemLanguages']}"
                               varStatus="counter">
                        <tr>
