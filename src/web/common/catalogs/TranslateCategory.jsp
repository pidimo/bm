...
<tr>
    <td>
    <html:form action="/Category/Translate/Save.do">
        ...
        <tr>
            <td colspan="3" class="title"><fmt:message  key="Category.Title.translate"/></td>
        </tr>
        <tr>
            <td class="label"><fmt:message key="Category.translation"/></td>
            <td class="label"><fmt:message key="Category.language"/></td>
            <td class="label"><fmt:message key="Category.defaultTranslation"/></td>
        </tr>
        <c:forEach var="langText" items="${translateCategoryForm.dtoMap['translatedSystemLanguages']}" varStatus="counter" >
        <tr>
