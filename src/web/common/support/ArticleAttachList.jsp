    ...
    <tr>
        <td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="90%" class="container" align="center">
                <tr>
                    <td>
                        <fanta:table width="100%" id="attach" action="ArticleAttach/List.do" imgPath="${baselayout}">
                            ...
                            <c:set var="deleteAction" value="ArticleAttach/Forward/Delete.do?index=3&dto(attachId)=${attach.attachId}&dto(supportAttachName)=${app2:encode(attach.fileName)}
&dto(articleTitle)=${app2:encode(param['dto(articleTitle)'])}&articleId=${param.articleId}"/>

                            <c:set var="download" value="ArticleAttach/Download.do?index=3&dto(attachId)=${attach.attachId}&dto(supportAttachName)=${app2:encode(attach.fileName)}
&dto(articleTitle)=${app2:encode(param['dto(articleTitle)'])}&articleId=${param.articleId}"/>
