...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="container">
    ...
    <TR>
        ...
        <html:form action="/SearchProduct.do" focus="parameter(productName)">
    ...
    <tr>
        <td colspan="2" align="center" class="alpha">
            <fanta:alphabet action="SearchProduct.do" parameterName="productNameSingle"/>
        </td>
    </tr>
    <tr>
        <td colspan="2" align="center">
            <br/>
            <fanta:table width="100%" id="product" action="SearchProduct.do" imgPath="${baselayout}">
