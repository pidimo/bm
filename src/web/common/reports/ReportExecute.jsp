...
<html:form action="${action}${urlReportId}" focus="dto(newReportTitle)">
    ...
    <tr>
        <td class="button">
            <c:choose>
                ...
                <c:otherwise>
                    <app2:securitySubmit operation="EXECUTE" functionality="REPORT" styleClass="button"
                                         tabindex="1">
                        <fmt:message key="EXECUTE"/>
                    </app2:securitySubmit>
                </c:otherwise>
...
<table id="Filter.jsp" border="0" cellpadding="0" cellspacing="0" width="80%" align="center" class="container">
    ...
    <tr>
        ...
        <td class="contain"><html:text property="dto(newReportTitle)" styleClass="mediumText"
                                       tabindex="1"/></td>
        <td class="label">
    ...
    <tr>
        ...
        <td class="contain" width="30%">
            ...
            <html:select property="dto(pageSize)" styleId="pageSize" styleClass="mediumSelect" tabindex="2">
        ...
        <td class="contain" width="30%">
            <c:set var="pageOrientations" value="${app2:getReportPageOrientations(pageContext.request)}"
                   scope="request"/>
            <html:select property="dto(pageOrientation)" styleId="pageOrientation" styleClass="mediumSelect"
                         tabindex="5">
    ...
    <tr id="csvSettingId" ${reportExecuteForm.dtoMap['reportFormat'] eq CSV_FORMAT ? "" : "style=\"display: none;\""}>
        <td class="label">
                        ...
                        <tr>
                            <td>
                                ...
                                <app:text property="dto(popupValue${idF})" styleId="popupValue${idF}" styleClass="text"
                                          readonly="true"
                                          tabindex="5"/>
                                <tags:selectPopup url="/reports/Report/Filter/ImportDBFilter.do" name="${idF}"
