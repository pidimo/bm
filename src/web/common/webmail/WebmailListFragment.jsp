                ...
                <c:if test="${folderColumnToShow eq SHOW_FROM_TO}">
                    <c:choose>
                        <c:when test="${mailList.INOUT == MAIL_OUT}">
                            <html:img src="${baselayout}/img/out_.gif" border="0"
                                      altKey="Webmail.folder.show.to"
                                      titleKey="Webmail.folder.show.to"/>
                        </c:when>
                        <c:otherwise>
                            <html:img src="${baselayout}/img/in_.gif" border="0"
                                      altKey="Webmail.folder.show.from"
...
<fanta:dataColumn name="" styleClass="listItemCenter" title="Webmail.tray.answeredOrForwarded"
                  ...
                  headerImage="${sessionScope.baselayout}/img/webmail/reply.gif">
    <c:choose>
...
<fanta:dataColumn name="MAILSUBJECT" action="${mailAction}" styleClass="listItem"
                  ...
                  headerStyle="listHeader" renderData="false" width="32%" orderable="true">
