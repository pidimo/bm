...
<html:form action="/CampaignFile/Delete.do">
    <html:hidden property="dto(op)" value="deleteFile"/>
    <html:hidden property="dto(campaignId)" value="${campaignTemplateForm.dtoMap['campaignId']}" />
    <html:hidden property="dto(campaignName)" value="${campaignTemplateForm.dtoMap['campaignName']}" />
    <html:hidden property="dto(maxAttachSize)" value="${sessionScope.user.valueMap['maxAttachSize']}"/>
    <html:hidden property="dto(companyId)" value="${sessionScope.user.valueMap['companyId']}"/>
    <html:hidden property="dto(languageId)" value="${campaignTemplateForm.dtoMap['languageId']}"/>
