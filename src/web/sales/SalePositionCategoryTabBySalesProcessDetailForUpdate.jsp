...
<c:set var="action"
       value="/SalesProcess/SalePosition/CategoryTab/Update.do?dto(salePositionId)=${param.salePositionId}&dto(categoryTabId)=${param.categoryTabId}&categoryTabId=${param.categoryTabId}"
       scope="request"/>

<c:set var="ajaxAction" value="/sales/SalePosition/ReadSubCategories.do" scope="request"/>

<c:set var="downloadAction"
       value="/sales/SalesProcess/SalePosition/DownloadCategoryFieldValue.do?dto(salePositionId)=${param.salePositionId}&salePositionId=${param.salePositionId}&dto(categoryTabId)=${param.categoryTabId}&categoryTabId=${param.categoryTabId}&index=${param.index}"
       scope="request"/>
