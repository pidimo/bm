...
<c:set var="helpResourceKey" value="help.salesProcess.task.create" scope="request"/>

<fmt:message var="title" key="Task.new" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Task/Create" scope="request"/>
<c:set var="op" value="create" scope="request"/>

<c:set var="windowTitle" value="Task.new" scope="request"/>
