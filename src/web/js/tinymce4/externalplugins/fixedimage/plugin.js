 ...
 *
 *
 * Changed by Miky, to manage local upload images
 */

/*global tinymce:true */

tinymce.PluginManager.add('fixedimage', function(editor) {
	...
	function showDialog(imageList) {
		...
		function onSubmitForm() {
			...
			editor.undoManager.transact(function() {
				...
				////////////// add by miky to manage upload images /////////////
				// define the id attribute in img element if this has been uploaded from local
				var uploadImage_id = editor.settings.my_uploadImageId_variable;

				if (typeof(uploadImage_id) != undefined && uploadImage_id != '') {
					dom.setAttrib(imgElm, 'id', uploadImage_id);
					editor.settings.my_uploadImageId_variable = '';
				}
