...
!function ($) {
	...
	var TabDrop = function (element, options) {
		...
		if (options.align === "left")
			this.dropdown = $('<li class="dropdown hide pull-left tabdrop"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="display-tab"></span><b class="caret"></b></a><ul class="dropdown-menu dropdownTabsDetail"></ul></li>');
		else
			this.dropdown = $('<li class="dropdown hide pull-right text-center tabdrop"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="display-tab"></span><b class="caret"></b></a><ul class="dropdown-menu dropdownTabsDetail"></ul></li>');
