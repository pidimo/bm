...
(function() {
    ...
    $.sexyCombo = function(b, c) {
        ...
        this.input = $("<input type='text' />").
                ...
                attr("class","form-control clearCheckInComboSexy").
                click(function() {
            hasFocus = true;
        });
...
//        add icon spam in select draw
        var div1 = $("<span class='glyphicon glyphicon-chevron-down' />");
        var div2 = $("<div class='icon' />");
        div2.append(div1);
        this.icon = div2.appendTo(this.wrapper);
        ...
        this.updateDrop();
        this.list = $("<ul class='quitPointUL' />").appendTo(this.listWrapper);
        var d = this;
    ...
    h.fn.extend({initEvents:function() {
        ...
        if(navigator.appVersion.indexOf("MSIE") !== -1)b += a;
