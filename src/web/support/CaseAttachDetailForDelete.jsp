...
<c:set var="helpResourceKey" value="help.supportCase.attach.delete" scope="request"/>

<fmt:message var="title" key="SupportAttach.Title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/CaseAttach/Delete.do?index=${param.index}" scope="request"/>
