...
<c:set var="helpResourceKey" value="help.article.link.delete" scope="request"/>

<fmt:message var="title" key="Link.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Article/Link/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="Link.delete" scope="request"/>
<c:set var="actionHistory" value="5" scope="request"/>
