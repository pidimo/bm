...
<c:set var="helpResourceKey" value="help.article.attach.create" scope="request"/>

<fmt:message var="title" key="SupportAttach.Title.create" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ArticleAttach/Create.do" scope="request"/>
<c:set var="op" value="create" scope="request"/>
<c:set var="actionValue" value="6" scope="request"/>
<c:set var="windowTitle" value="SupportAttach.Title.create" scope="request"/>
