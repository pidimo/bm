...
<c:set var="helpResourceKey" value="help.article.attach.edit" scope="request"/>

<fmt:message var="title" key="SupportAttach.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/ArticleAttach/Update.do" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="actionValue" value="7" scope="request"/>
...
<c:set var="attachDownload" value="/ArticleAttach/Download.do?index=3" scope="request"/>
