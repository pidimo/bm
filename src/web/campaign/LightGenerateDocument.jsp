...
<c:set var="helpResourceKey" value="help.campaign.recipient.generate.word" scope="request"/>

<fmt:message var="title" key="Campaign.activity.docGenerate.title" scope="request"/>

<c:set var="action" value="/Campaign/Light/Generate/Document" scope="request"/>
