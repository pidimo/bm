...
<c:set var="helpResourceKey" value="help.campaign.activity.generate.html" scope="request"/>

<fmt:message    var="title" key="Campaign.activity.emailSend.title" scope="request"/>

<c:set var="action" value="/Campaign/Email/Send" scope="request"/>
...
<c:set var="urlWithoutEmail" value="/Campaign/Email/Recipient/WithoutEmail.do" scope="request"/>
