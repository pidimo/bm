...
<c:set var="helpResourceKey" value="help.campaign.activity.delete" scope="request"/>

<fmt:message var="title" key="CampaignActivity.Title.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>

<c:set var="action" value="/CampaignActivity/Delete.do" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="CampaignActivity.Title.delete" scope="request"/>
