...
<c:set var="helpResourceKey" value="help.campaign.recipient.generate.html.summary" scope="request"/>
...
<app:url var="urlGenerateEmailReturn" value="/Recipients/List.do" context="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:if test="${'true' eq sendInBackgroundSummary}">
            <c:set var="helpResourceKey" value="help.campaign.recipient.generate.html.sendInBackGround" scope="request"/>
