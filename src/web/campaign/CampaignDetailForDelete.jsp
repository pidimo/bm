...
<c:set var="helpResourceKey" value="help.campaign.delete" scope="request"/>

<fmt:message var="title" key="Campaign.delete" scope="request"/>
<fmt:message var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Campaign/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>
<c:set var="windowTitle" value="Campaign.delete" scope="request"/>
