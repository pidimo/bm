...
<c:set var="helpResourceKey" value="help.campaign.activity.user.automaticAssign.delete" scope="request"/>

<fmt:message   var="title" key="Campaign.activity.user.title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Activity/User/AutomaticAssign/Delete" scope="request"/>
