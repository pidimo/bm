...
<c:set var="helpResourceKey" value="help.campaign.selectionCriteria.edit" scope="request"/>

<fmt:message var="title" key="Campaign.criterion.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Campaign/SelectionCriteria/Update.do" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="ope" value="read" scope="request"/>
<c:set var="windowTitle" value="Campaign.criterion.update" scope="request"/>
