...
<c:set var="helpResourceKey" value="help.campaign.attach.edit" scope="request"/>

<fmt:message var="title" key="Attach.Title.update" scope="request"/>
<fmt:message var="button" key="Common.save" scope="request"/>

<c:set var="action" value="/Attach/Update.do" scope="request"/>
<c:set var="op" value="update" scope="request"/>
<c:set var="windowTitle" value="Attach.Title.update" scope="request"/>
