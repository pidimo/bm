...
<c:set var="helpResourceKey" value="help.campaign.activity.generate.html.summary" scope="request"/>
...
<app:url var="urlGenerateEmailReturn" value="/CampaignActivity/Forward/Update.do?dto(activityId)=${param.activityId}&dto(campaignId)=${param.campaignId}&dto(op)=read" context="request"/>
...
<c:choose>
    <c:when test="${sessionScope.isBootstrapUI}">
        ...
        <c:if test="${'true' eq sendInBackgroundSummary}">
            <c:set var="helpResourceKey" value="help.campaign.activity.generate.html.sendInBackGround" scope="request"/>
