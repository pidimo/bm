...
<c:set var="helpResourceKey" value="help.campaign.activity.user.automaticAssign.edit" scope="request"/>

<fmt:message   var="title" key="Campaign.activity.user.title.update" scope="request"/>
<fmt:message   var="button" key="Common.save" scope="request"/>
<c:set var="action" value="/Activity/User/AutomaticAssign/Update" scope="request"/>
