...
<c:set var="helpResourceKey" value="help.campaign.activity.contact.delete" scope="request"/>

<fmt:message   var="title" key="Campaign.activity.campContact.title.delete" scope="request"/>
<fmt:message   var="button" key="Common.delete" scope="request"/>
<c:set var="action" value="/Campaign/Activity/CampContact/Delete" scope="request"/>
<c:set var="op" value="delete" scope="request"/>

<c:set var="pagetitle" value="Campaign.plural" scope="request"/>
<c:set var="windowTitle" value="Campaign.activity.campContact.title.delete" scope="request"/>
