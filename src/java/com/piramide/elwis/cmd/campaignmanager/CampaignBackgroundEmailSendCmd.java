...
/**
 * Cmd to send campaign activity in  background
 * @author Miguel A. Rojas Cardenas
 * @version 5.3.5
 */
public class CampaignBackgroundEmailSendCmd extends CampaignRetryEmailSendCmd {
    ...
    public void executeInStateless(SessionContext ctx) {
        log.debug("Executing CampaignBackgroundEmailSendCmd..... " + paramDTO);
