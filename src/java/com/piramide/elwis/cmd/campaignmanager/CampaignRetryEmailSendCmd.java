 ...
 * @version 4.9
 */
public class CampaignRetryEmailSendCmd extends CampaignEmailSendCmd {
    ...
    public void executeInStateless(SessionContext ctx) {
        log.debug("Executing CampaignRetryEmailSendCmd..... " + paramDTO);
    ...
    protected Integer processAndGetCampaignSentLogId(Integer generationId, Long generationKey, Integer activityId, Integer companyId) {
        ...
        try {
            ...
            log.error("Error in execute retry CampaignSentLogCmd cmd..", e);
        }
    ...
    protected void processSentLogContact(Integer campaignSentLogId, Long generationKey, Integer companyId, Map contactInfoMap) {
        ...
        try {
            ...
            log.error("Error in execute retry SentLogContactCmd cmd..", e);
        }
    }
        ...
        if (listIdAttach != null && listIdAttach.trim().length() > 0) {
            ...
            for (int i = 0; i < attachIDs.length; i++) {
                ...
                if (attachment != null) {
                    ...
                    try {
                        //verify if file already exist in cache
                        if (!file.isFile()) {
