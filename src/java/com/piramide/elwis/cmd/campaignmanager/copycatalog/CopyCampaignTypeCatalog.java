package com.piramide.elwis.cmd.campaignmanager.copycatalog;
...
import com.piramide.elwis.dto.catalogmanager.CampaignTypeDTO;
 ...
 * @author: ivan
 */
public class CopyCampaignTypeCatalog implements CopyCatalog {
    ...
    public void copyCatalog(Company source, Company target, SessionContext sessionContext) {
        ...
        CopyCatalogUtil.i.copyCatalog(source, target, new CampaignTypeDTO());
    }
}
