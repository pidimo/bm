 ...
 * referencial integriry and entry duplicated); all relatinated with the City
 *
 * @author Yumi
 * @version $Id: CityCmd.java 7936 2007-10-27 16:08:39Z fernando ${NAME}.java, v 2.0 29-abr-2004 11:21:49 Exp $
 */
public class CityCmd extends GeneralCmd {
    private Log log = LogFactory.getLog(this.getClass());

    public void executeInStateless(SessionContext ctx) {
        log.debug("Executing CityCmd...");
        super.setOp(this.getOp());
        super.executeInStateless(ctx, paramDTO, CityDTO.class);
    }
