 ...
 */
public class ContactPersonReportAction extends ReportAction {
    private Log log = LogFactory.getLog(ContactPersonReportAction.class);

    public ActionForward execute(ActionMapping mapping,
                                 ActionForm form,
                                 HttpServletRequest request,
                                 HttpServletResponse response) throws Exception {
        log.debug("--- ContactPersonReportAction      execute  ....");
