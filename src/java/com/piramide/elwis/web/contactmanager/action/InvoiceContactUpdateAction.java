 ...
 *
 * @author Miky
 * @version $Id: InvoiceContactUpdateAction.java 18-sep-2008 16:47:46 $
 */
public class InvoiceContactUpdateAction extends ContactManagerAction {
    public ActionForward execute(ActionMapping mapping,
                                 ActionForm form,
                                 HttpServletRequest request,
                                 HttpServletResponse response) throws Exception {
        log.debug("Executing InvoiceContactUpdateAction........" + request.getParameterMap());
