...
/**
 * Jatun S.R.L.
 * action to manage campaign document generation
 *
 * @author Miky
 * @version $Id: CampaignGenerateDocumentAction.java 10285 2012-11-28 05:59:23Z miguel $
 */
public class CampaignGenerateDocumentAction extends CampaignActivityManagerAction {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        log.warn("Executing CampaignGenerateDocumentAction...." + request.getParameterMap());
        ...
        try {
            ListStructure listStructure = fantabulousManager.getList("DocumentGenerationActivityContactList");
            ...
            log.warn("Not found list........... DocumentGenerationActivityContactList", e);
        }
        ...
        if ("Success".equals(forward.getName())) {
            ...
            String activityId = dtoValues.get("activityId").toString();
            ...
            if (isCreateCommunications) {
                createDocumentGenerationCommunications(new Integer(campaignId), new Integer(activityId), new Integer(companyId),
    ...
    private void createDocumentGenerationCommunications(Integer campaignId, Integer activityId, Integer companyId, Integer templateId,
                                                        String note, List<Map> contactInfoList, HttpServletRequest request) {
        log.debug("create comm in document generation......");
