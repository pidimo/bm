...
public class TaskCreateAction extends CheckEntriesForwardAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        taskForm.setDto("addressId", request.getParameter("addressId"));
        taskForm.setDto("contact", request.getParameter("addressName"));
        taskForm.setDto("processId", request.getParameter("processId"));
