...
import com.piramide.elwis.cmd.catalogmanager.TelecomTypeTranslationCmd;
 ...
 */
public class TelecomtypeTranslationForm extends DefaultForm {
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (null != isDefault) {
            ...
            errors.add("isDefautlNotFound", new ActionError("errors.required", JSPHelper.getMessage(request, "TelecomType.defaultTranslation")));
        }


        if (!errors.isEmpty()) {
            Integer categoryId = new Integer((String) getDto("telecomTypeId"));
            String categoryName = (String) getDto("telecomTypeName");

            TelecomTypeTranslationCmd cmd = new TelecomTypeTranslationCmd();
            cmd.setOp("read");
            cmd.putParam("telecomTypeId", categoryId);
            cmd.putParam("telecomTypeName", categoryName);
            ...
            try {
                ...
                log.error("Cannot execute TelecomTypeTranslationCmd... ", e);
            }
        }
