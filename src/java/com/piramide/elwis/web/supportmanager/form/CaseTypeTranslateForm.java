...
import com.piramide.elwis.cmd.supportmanager.CaseTypeTranslationCmd;
 ...
 */
public class CaseTypeTranslateForm extends DefaultForm {
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (!errors.isEmpty()) {
            Integer id = new Integer((String) getDto("caseTypeId"));
            String name = (String) getDto("caseTypeName");

            CaseTypeTranslationCmd cmd = new CaseTypeTranslationCmd();
            cmd.setOp("read");
            cmd.putParam("caseTypeId", id);
            cmd.putParam("caseTypeName", name);
