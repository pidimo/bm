...
import com.piramide.elwis.cmd.supportmanager.CaseSeverityTranslationCmd;
 ...
 */
public class CaseSeverityTranslateForm extends DefaultForm {
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (!errors.isEmpty()) {
            Integer id = new Integer((String) getDto("severityId"));
            String name = (String) getDto("severityName");

            CaseSeverityTranslationCmd cmd = new CaseSeverityTranslationCmd();
            cmd.setOp("read");
            cmd.putParam("severityId", id);
            cmd.putParam("severityName", name);
