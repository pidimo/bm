...
import com.piramide.elwis.cmd.supportmanager.WorkLevelTranslationCmd;
 ...
 */
public class WorkLevelTranslateForm extends DefaultForm {
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (!errors.isEmpty()) {
            Integer id = new Integer((String) getDto("workLevelId"));
            String name = (String) getDto("workLevelName");

            WorkLevelTranslationCmd cmd = new WorkLevelTranslationCmd();
            cmd.setOp("read");
            cmd.putParam("workLevelId", id);
            cmd.putParam("workLevel", name);
