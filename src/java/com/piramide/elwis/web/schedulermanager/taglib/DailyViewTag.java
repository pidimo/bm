...
public class DailyViewTag extends TableBaseTag {
    ...
    public int doStartTag() throws JspException {
        ...
        //renderCloseSPAN(html);
        renderCloseTH(html);
        renderOpenTH(html, appointmentDay.getProcessedColumns(), -1, null, null, APPOINTMENT_HEADER_WIDTH, true);
        ...
        renderOpenTR(html, HEADER_CSS);
        renderOpenTH(html, null, "text-align: right;", "50%", false);
        //renderOpenSPAN(html, DAILY_TITLE_CSS);
