 ...
 *
 * @author ivan
 * @version $Id: AppointmentComponentBootstrapTag.java 12553 2016-05-30 22:58:53Z miguel ${CLASS_NAME}.java,v 1.2 01-06-2005 03:31:55 PM ivan Exp $
 */
public class AppointmentComponentBootstrapTag extends DailyViewBootstrapTag {
    ...
    public int doStartTag() throws JspException {
        ...
        html.append("<table");
        html.append(" width=\"100%\" class=\"");
        html.append(StyleClassFunctions.getGeneralFantabulousTableClasses());
        html.append("\" >");
        // Header of Table;
        renderOpenTR(html, "HeaderDashBoard");

        //APPOINTMENT_HEADER_WIDTH
        renderOpenTH(html, 2, -1, "listHeaderDashBoard listHeader", null, null, true);
    ...
    protected void myRenderCellAppointment(StringBuffer html,
        ...
        renderOpenTD(html, "listItem2", "width:20%;border-right-style:none;padding-right:0px;", null, true);
