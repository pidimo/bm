 ...
 *
 * @author Miky
 * @version $Id: AppointmentSimpleAdvancedListAction.java 16-mar-2009 15:27:57 $
 */
public class AppointmentSimpleAdvancedListAction extends AppointmentCreateListAction {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        log.debug("Executing AppointmentSimpleAdvancedListAction ..." + request.getParameterMap());
        ...
        //execute simple appointment search
