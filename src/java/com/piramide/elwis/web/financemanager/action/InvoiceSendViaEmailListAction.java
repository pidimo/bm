 ...
 * @version 6.1
 */
public class InvoiceSendViaEmailListAction extends ListAction {
    protected static Log log = LogFactory.getLog(InvoicePrintListAction.class);

    public ActionForward execute(ActionMapping mapping,
                                 ActionForm form,
                                 HttpServletRequest request,
                                 HttpServletResponse response) throws Exception {
        log.debug("Executing InvoiceSendViaEmailListAction........" + request.getParameterMap());

        //parameters to execute list of manual form to Send all invoices
        ...
        //read ids to all send action
        String listName = "invoiceSendViaEmailList";
    ...
    private void executeListToReadAllInvoiceId(HttpServletRequest request, String listName, Parameters parameters, ActionForm form) {
        ...
        request.setAttribute("allSendInvoiceIds", ids);
    }
