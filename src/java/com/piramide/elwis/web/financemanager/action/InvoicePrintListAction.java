 ...
 *
 * @author Miky
 * @version $Id: InvoicePrintListAction.java 13-oct-2008 16:25:02 $
 */
public class InvoicePrintListAction extends ListAction {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        log.debug("Executing InvoicePrintListAction........" + request.getParameterMap());
        ...
        String listName = "invoicePrintList";
