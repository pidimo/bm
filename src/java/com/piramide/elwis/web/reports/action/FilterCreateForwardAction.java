 ...
 *
 * @author Miky
 * @version $Id: FilterCreateForwardAction.java 9695 2009-09-10 21:34:43Z fernando $
 */

public class FilterCreateForwardAction extends ReportManagerForwardAction {
    private Log log = LogFactory.getLog(this.getClass());

    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        log.debug("Executing FilterCreateForwardAction................");
