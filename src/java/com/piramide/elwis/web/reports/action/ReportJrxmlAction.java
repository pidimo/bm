 ...
 * @version 4.10
 */
public class ReportJrxmlAction extends DefaultAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Object isChangeCompany = myForm.getDto("isChangeCompany");
        ...
        } else if (null != moduleButton || "true".equals(isChangeCompany)) {
