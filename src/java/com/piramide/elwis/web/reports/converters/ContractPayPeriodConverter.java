 ...
 *
 * @author Miky
 * @version $Id: ContractPayPeriodConverter.java 11-feb-2009 18:05:05 $
 */
public class ContractPayPeriodConverter implements Converter {
    ...
    public FieldValue dbToView(Field field, Map map, Pair[] pairs, ResourceBundleWrapper resourceBundleWrapper, String titusPath) {
        ...
        if (fieldPairValue != null && !"".equals(fieldPairValue)) {
            ...
            fvObj = new FieldValue(rowValue + " " + resourceBundleWrapper.getMessage("ProductContract.payPeriod.months"), fieldPairValue);
