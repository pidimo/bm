...
public class InOutConverter implements Converter {
    ...
    public FieldValue dbToView(Field field, Map map, Pair[] pairs, ResourceBundleWrapper resourceBundleWrapper, String titusPath) {
        ...
        if (fieldPairValue != null && !"".equals(fieldPairValue)) {
            ...
            if (("0").equals(opeValue)) {
                fvObj = new FieldValue(resourceBundleWrapper.getMessage("Document.out"), fieldPairValue);
            } else if (("1").equals(opeValue)) {
                fvObj = new FieldValue(resourceBundleWrapper.getMessage("Document.in"), fieldPairValue);
            }
        } else {
