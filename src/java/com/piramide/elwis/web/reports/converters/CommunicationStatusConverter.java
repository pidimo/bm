...
public class CommunicationStatusConverter implements Converter {
    ...
    public FieldValue dbToView(Field field, Map map, Pair[] pairs, ResourceBundleWrapper resourceBundleWrapper, String titusPath) {
        ...
        if (fieldPairValue != null && !"".equals(fieldPairValue)) {
            ...
            if (("0").equals(opeValue)) {
                fvObj = new FieldValue(resourceBundleWrapper.getMessage("Common.open"), fieldPairValue);
            } else if (("1").equals(opeValue)) {
                fvObj = new FieldValue(resourceBundleWrapper.getMessage("Common.close"), fieldPairValue);
            }
        } else {
